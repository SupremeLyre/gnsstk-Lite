...
CommandOption1Example ::CommandOption1Example(const string &applName)
    : BasicFramework(applName, "Example application for CommandOption"), fileOpt('f', "file", "input file", true),
      screamOpt(0, "scream", "print a message very loudly"), restOpt("FILE [...]", true)
{
    fileOpt.setMaxCount(1);
}

bool CommandOption1Example ::initialize(int argc, char *argv[], bool pretty) noexcept
{
