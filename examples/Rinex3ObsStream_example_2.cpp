...
/** @file Rinex3ObsStream_example_2.cpp implements an example of using
 * Rinex3ObsStream for input and doing some rudimentary processing on
 * the data (in this case, computing and printing biased
 * multipath). */
