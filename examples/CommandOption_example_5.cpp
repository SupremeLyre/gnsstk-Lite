...
CommandOption5Example ::CommandOption5Example(const string &applName)
    : BasicFramework(applName, "Example application for CommandOption"), xOpt('x', "", "you say you want an x"),
      yOpt('y', "", "you say you want an y"), zOpt('z', "", "you say you want an z"),
      screamOpt(0, "scream", "print a message very loudly"), hushOpt(0, "hush", "don't print a message very loudly"),
...
bool CommandOption5Example ::initialize(int argc, char *argv[], bool pretty) noexcept
{
    ...
    cout << "You specified x,y, and/or z a total of " << xyzOpts.getCount() << " times" << endl;
    return true;
}

void CommandOption5Example ::process()
{
    cout << "Nothing to do" << endl;
}

void CommandOption5Example ::shutDown()
{
