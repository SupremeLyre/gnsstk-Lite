...
CommandOption4Example ::CommandOption4Example(const string &applName)
...
bool CommandOption4Example ::initialize(int argc, char *argv[], bool pretty) noexcept
{
...
void CommandOption4Example ::process()
{
    cout << "Nothing to do" << endl;
}

void CommandOption4Example ::shutDown()
{
