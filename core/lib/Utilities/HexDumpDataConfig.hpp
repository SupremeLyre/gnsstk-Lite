...
#ifndef GNSSTK_HEXDUMPDATACONFIG_HPP
#define GNSSTK_HEXDUMPDATACONFIG_HPP
...
class HexDumpDataConfig
{
  public:
     ...
     */
    HexDumpDataConfig(bool ashowIndex, bool ahexIndex, bool aupperHex, unsigned aidxDigits, unsigned aindexWS,
                      unsigned agroupBy, unsigned agroupWS, unsigned agroup2By, unsigned agroup2WS,
                      unsigned abytesPerLine, bool ashowText, char aseparator, unsigned atextWS,
                      bool aShowBaseData = false, bool aShowBaseIndex = false);
    /** Set fields using explicit strings for the separators.
     * @see data member documentation for an explanation of arguments.
     */
    HexDumpDataConfig(bool ashowIndex, bool ahexIndex, bool aupperHex, unsigned aidxDigits,
                      const std::string &aindexSep, unsigned agroupBy, const std::string &agroupSep, unsigned agroup2By,
                      const std::string &agroup2Sep, unsigned abytesPerLine, bool ashowText, char aseparator,
                      const std::string &atextSep, bool aShowBaseData, bool aShowBaseIndex,
                      const std::string &adataEndSep, const std::string &adataFinal);
    /** Set fields using explicit strings for the separators.
     * @see data member documentation for an explanation of arguments.
     */
    HexDumpDataConfig(bool ashowIndex, bool ahexIndex, bool aupperHex, unsigned aidxDigits,
                      const std::string &aindexSep, unsigned agroupBy, const std::string &agroupSep, unsigned agroup2By,
                      const std::string &agroup2Sep, unsigned abytesPerLine, bool ashowText,
                      const std::string &apreText, const std::string &apostText, bool aShowBaseData,
                      bool aShowBaseIndex, const std::string &adataEndSep, const std::string &adataFinal,
...
#endif // GNSSTK_HEXDUMPDATACONFIG_HPP
