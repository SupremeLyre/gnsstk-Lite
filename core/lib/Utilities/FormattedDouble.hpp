...
#ifndef GNSSTK_FORMATTEDDOUBLE_HPP
#define GNSSTK_FORMATTEDDOUBLE_HPP
...
class FormattedDouble
{
  public:
     ...
     */
    FormattedDouble(double d, StringUtils::FFLead lead, unsigned mantissa = 0, unsigned exponent = 2,
                    unsigned width = 0, char expChar = 'e', StringUtils::FFSign sign = StringUtils::FFSign::NegOnly,
     ...
     *   properly read a formatted value.
     */
    explicit FormattedDouble(const std::string &str, unsigned width = 0, char expChar = 'e');
