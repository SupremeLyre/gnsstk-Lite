...
#ifndef GNSSTK_RNDOUBLE_HPP
#define GNSSTK_RNDOUBLE_HPP
...
class RNDouble : public FormattedDouble
{
  public:
    ...
    RNDouble(double d = 0)
        : FormattedDouble(d, StringUtils::FFLead::Decimal, 12, 2, 19, 'D', StringUtils::FFSign::NegOnly,
                          StringUtils::FFAlign::Right)
    {
    }
    /// Decode a string.
    RNDouble(const std::string &str) : FormattedDouble(str, 19, 'D')
    {
    }
