 ...
 */
void hexDumpData(const std::string &data, std::ostream &s, const HexDumpDataConfig &cfg = HexDumpDataConfig());
 ...
 */
inline void hexDumpData(std::ostream &s, const std::string &data, unsigned indent = 0,
 ...
 * @param cfg formatting configuration.
 */
inline void hexDumpData(std::ostream &s, const std::string &data, const std::string &tag,
 ...
 */
inline std::string &stripLeading(std::string &s, const std::string &aString,
 ...
 * @return a reference to \a s.
 */
inline std::string stripLeading(const std::string &s, const std::string &aString,
                                std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &stripLeading(std::string &s, const char *pString, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string stripLeading(const std::string &s, const char *pString,
                                std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &stripLeading(std::string &s, const char aCharacter, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string stripLeading(const std::string &s, const char aCharacter,
                                std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &stripLeading(std::string &s, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string stripLeading(const std::string &s, std::string::size_type num = std::string::npos)
{
    std::string t(s);
    stripLeading(t, std::string(1, ' '), num);
    return t;
}
 ...
 * @return a reference to \a s.
 */
inline std::string &stripTrailing(std::string &s, const std::string &aString,
                                  std::string::size_type num = std::string::npos);
 ...
 * @return a reference to \a s.
 */
inline std::string stripTrailing(const std::string &s, const std::string &aString,
                                 std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &stripTrailing(std::string &s, const char *pString, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string stripTrailing(const std::string &s, const char *pString,
                                 std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &stripTrailing(std::string &s, const char aCharacter, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string stripTrailing(const std::string &s, const char aCharacter,
                                 std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &stripTrailing(std::string &s, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string stripTrailing(const std::string &s, std::string::size_type num = std::string::npos)
{
    std::string t(s);
    stripTrailing(t, std::string(1, ' '), num);
    return t;
}
 ...
 * @return a reference to \a s.
 */
inline std::string &strip(std::string &s, const std::string &aString, std::string::size_type num = std::string::npos);
 ...
 * @return a reference to \a s.
 */
inline std::string strip(const std::string &s, const std::string &aString,
                         std::string::size_type num = std::string::npos)
{
    std::string t(s);
    strip(t, aString, num);
 ...
 * @return a reference to \a s.
 */
inline std::string &strip(std::string &s, const char *pString, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string strip(const std::string &s, const char *pString, std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &strip(std::string &s, const char aCharacter, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string strip(const std::string &s, const char aCharacter, std::string::size_type num = std::string::npos)
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &strip(std::string &s, std::string::size_type num = std::string::npos)
{
 ...
 * @return a reference to \a s.
 */
inline std::string strip(const std::string &s, std::string::size_type num = std::string::npos)
{
    std::string t(s);
    strip(t, std::string(1, ' '), num);
    return t;
}
 ...
 */
inline std::string translate(const std::string &aString, const std::string &inputChars, const std::string &outputChars,
                             const char pad = ' ');
 ...
 *   pattern.
 */
inline std::string change(const std::string &aString, const std::string &inputString, const std::string &outputString,
 ...
 *   pattern.
 */
inline std::string &change(std::string &aString, const std::string &inputString, const std::string &outputString,
                           std::string::size_type startPos = 0,
                           unsigned numChanges = (std::numeric_limits<unsigned>::max)());
 ...
 * @throw StringException if there's a std::exception thrown.
 * @return a reference to \a s.  */
inline std::string &rightJustify(std::string &s, const std::string::size_type length, const char pad = ' ');
 ...
 * @throw StringException if there's a std::exception thrown.
 * @return a reference to \a s.  */
inline std::string rightJustify(const std::string &s, const std::string::size_type length, const char pad = ' ')
{
    std::string t(s);
 ...
 * @throw StringException if there's a std::exception thrown.
 * @return a reference to \a s.  */
inline std::string &leftJustify(std::string &s, const std::string::size_type length, const char pad = ' ');
 ...
 * @throw StringException if there's a std::exception thrown.
 * @return a reference to \a s.  */
inline std::string leftJustify(const std::string &s, const std::string::size_type length, const char pad = ' ')
{
    std::string t(s);
 ...
 * @return a reference to \a s.
 */
inline std::string &center(std::string &s, const std::string::size_type length, const char pad = ' ');
 ...
 * @return a reference to \a s.
 */
inline std::string center(const std::string &s, const std::string::size_type length, const char pad = ' ')
{
    std::string t(s);
 ...
 * @throw StringException
 */
template <class X> inline X asData(const std::string &s);
 ...
 */
inline std::string asString(const long double x, const std::string::size_type precision = 21);
 ...
 * @return string representation of \a x.
 */
inline std::string asString(const double x, const std::string::size_type precision = 17);
 ...
 * @throw StringException
 */
inline std::string &replaceAll(std::string &s, const std::string &oldString, const std::string &newString);
 ...
 * @throw StringException
 */
inline std::string matches(const std::string &s, const std::string &aPattern, const char zeroOrMore = '*',
                           const char oneOrMore = '+', const char anyChar = '.');
 ...
 * @throw StringException
 */
inline bool isLike(const std::string &s, const std::string &aPattern, const char zeroOrMore = '*',
                   const char oneOrMore = '+', const char anyChar = '.')
{
    return matches(s, aPattern, zeroOrMore, oneOrMore, anyChar) != std::string();
}
 ...
 * @throw StringException
 */
inline bool isLike(const std::string &s, const char *pPattern, const char zeroOrMore = '*', const char oneOrMore = '+',
                   const char anyChar = '.')
{
    return matches(s, std::string(pPattern), zeroOrMore, oneOrMore, anyChar) != std::string();
}
 ...
 * @throw StringException
 */
inline std::string subString(const std::string &s, const std::string::size_type startPos = 0,
                             const std::string::size_type length = std::string::npos, const char pad = ' ');
 ...
 */
inline std::string memToString(const void *p, const std::string::size_type size);
 ...
 * @throw StringException
 */
inline std::string firstWord(const std::string &s, const char delimiter = ' ');
 ...
 * @throw StringException
 */
inline int numWords(const std::string &s, const char delimiter = ' ');
 ...
 * @throw StringException
 */
inline std::string words(const std::string &s, const std::string::size_type firstWord = 0,
                         const std::string::size_type numWords = std::string::npos, const char delimiter = ' ');
 ...
 * @throw StringException
 */
inline std::string word(const std::string &s, const std::string::size_type wordNum = 0, const char delimiter = ' ')
{
 ...
 * @throw StringException
 */
inline std::string stripFirstWord(std::string &s, const char delimiter = ' ');
 ...
 * @throw StringException
 */
inline std::string &removeWords(std::string &s, const std::string::size_type first = 0,
 ...
 */
inline std::string doub2sci(const double &d, const std::string::size_type length, const std::string::size_type expLen,
                            const bool showSign = true, const bool checkSwitch = true);
 ...
 * tagged release of Q4 2020.
 */
inline std::string doubleToScientific(const double &d, const std::string::size_type length,
                                      const std::string::size_type precision, const std::string::size_type explen,
                                      bool showPlus = false);
 ...
 * tagged release of Q4 2020.
 */
inline std::string &sci2for(std::string &aStr, const std::string::size_type startPos = 0,
                            const std::string::size_type length = std::string::npos,
                            const std::string::size_type expLen = 3, const bool checkSwitch = true);
 ...
 * tagged release of Q4 2020.
 */
inline std::string doub2for(const double &d, const std::string::size_type length, const std::string::size_type expLen,
 ...
 * tagged release of Q4 2020.
 */
inline double for2doub(const std::string &aStr, const std::string::size_type startPos = 0,
                       const std::string::size_type length = std::string::npos);
 ...
 */
std::string floatFormat(double d, FFLead lead, unsigned mantissa, unsigned exponent, unsigned width = 0,
                        char expChar = 'e', FFSign sign = FFSign::NegOnly, FFAlign align = FFAlign::Left);
 ...
 * @throw StringException
 */
inline std::string &prettyPrint(std::string &aStr, const std::string &lineDelim = "\n", const std::string &indent = "",
                                const std::string &firstIndent = "     ", const std::string::size_type len = 80,
 ...
 * @throw StringException
 */
inline std::string prettyPrint(const std::string &aStr, const std::string &lineDelim = "\n",
                               const std::string &indent = "", const std::string &firstIndent = "     ",
                               const std::string::size_type len = 80, const char wordDelim = ' ')
{
...
inline std::string tabularize(const std::vector<std::string> &cells, std::string::size_type width = 80,
                              bool force = false);
 ...
 */
inline std::vector<std::string> split(const std::string &aStr, const std::string &theDelimiters,
                                      bool trimWhitespace = false, bool ignoreEmpty = true);
...
/// @param  ignoreEmpty    will ignore the empty tokens, default is true
inline std::vector<std::string> splitWithQuotes(const std::string &aStr, const char delimiter = ' ',
                                                bool trimWhitespace = true, bool ignoreEmpty = true);
...
/// @param  trimWhitespace will trim the token string, default is true
/// @param  ignoreEmpty    will ignore the empty tokens, default is true
inline std::vector<std::string> splitWithDoubleQuotes(const std::string &aStr, const char delimiter = ' ',
                                                      bool trimWhitespace = true, bool ignoreEmpty = true);
} // namespace StringUtils
...
namespace StringUtils
{
inline void hexDumpData(std::ostream &s, const std::string &data, unsigned indent, const HexDumpDataConfig &cfg)
{
    std::string tagstr(indent, ' ');
    hexDumpData(s, data, tagstr, cfg);
}

inline void hexDumpData(std::ostream &s, const std::string &data, const std::string &tag, HexDumpDataConfig cfg)
{
    cfg.prefix = tag;
...
inline std::string &stripLeading(std::string &s, const std::string &aString, std::string::size_type num)
{
    try
    {
        if (aString == "")
        ...
        while ((num > 0) && (s.find(aString, 0) == 0) && (s.length() > 0))
        {
...
inline std::string &stripTrailing(std::string &s, const std::string &aString, std::string::size_type num)
{
    try
    {
        ...
        while ((num > 0) && (s.length() >= aString.length()) && (s.rfind(aString, pos) == pos))
        {
...
inline std::string &strip(std::string &s, const std::string &aString, std::string::size_type num)
{
                             ...
                             const char pad)
{
    ...
    while ((aspos = rv.find_first_of(inputChars, aspos)) != std::string::npos)
    {
...
inline std::string &change(std::string &aString, const std::string &inputString, const std::string &outputString,
                           std::string::size_type startPos, unsigned numChanges)
{
    if (inputString.empty() || aString.empty())
        return aString;
    unsigned count = 0;
...
template <class T>
inline std::string formattedPrint(const std::string &fmt, const std::string &pat, const std::string &rep, T to)
{
#if defined(_WIN32) && _MSC_VER >= 1700
...
inline std::string subString(const std::string &s, const std::string::size_type startPos,
                             const std::string::size_type length, const char pad)
{
    try
    {
...
inline std::string words(const std::string &s, const std::string::size_type firstWord,
                         const std::string::size_type numWords, const char delimiter)
{
    try
    {
...
inline std::vector<std::string> split(const std::string &aStr, const std::string &theDelimiters, bool trimWhitespace,
                                      bool ignoreEmpty)
{
...
inline std::vector<std::string> splitWithQuotes(const std::string &aStr, const char delimiter, bool trimWhitespace,
                                                bool ignoreEmpty)
{
    std::vector<std::string> toReturn;
    ...
    while (endPos != std::string::npos && endPos <= aStr.length())
    {
        ...
        if (aStr.compare(begPos, 1, "\"") == 0)
            currentDelimiter = '"';
        if (aStr.compare(begPos, 1, "\'") == 0)
            currentDelimiter = '\'';

        // find next delimiter
        endPos = aStr.find_first_of(currentDelimiter, begPos + (currentDelimiter == delimiter ? 0 : 1));
        ...
        if (currentDelimiter != delimiter && std::string::npos != endPos)
            endPos++;
        ...
        if (trimWhitespace)
            token = gnsstk::StringUtils::strip(token);
...
inline std::vector<std::string> splitWithDoubleQuotes(const std::string &aStr, const char delimiter,
                                                      bool trimWhitespace, bool ignoreEmpty)
{
    std::vector<std::string> toReturn;
    std::string::size_type begPos = 0;
    std::string::size_type endPos = 0;
...
inline std::string &removeWords(std::string &s, const std::string::size_type first,
                                const std::string::size_type wordsToReplace, const char delimiter)
{
    try
    {
        ...
        for (std::string::size_type thisWord = 0; sPos != std::string::npos; thisWord++)
        {
            ...
            else if ((wordsToReplace != std::string::npos) && (thisWord >= first + wordsToReplace))
            {
...
inline std::string doub2sci(const double &d, const std::string::size_type length, const std::string::size_type expLen,
                            const bool showSign, const bool checkSwitch)
{
    std::string toReturn;
                                      ...
                                      bool showPlus)
{
    ...
    str2 += StringUtils::rightJustify(StringUtils::asString(StringUtils::asInt(str1)), elen, '0');
...
inline std::string &sci2for(std::string &aStr, const std::string::size_type startPos,
...
inline double for2doub(const std::string &aStr, const std::string::size_type startPos,
...
inline std::string &prettyPrint(std::string &aStr, const std::string &lineDelim, const std::string &indent,
                                const std::string &firstIndent, const std::string::size_type len, const char wordDelim)
{
    try
    {
        std::string newStr(firstIndent);
        // positions of word and line delimiters in aStr
        std::string::size_type wordPos = 0, linePos = 0, curPos = 0, curLineLen = newStr.length(), minPos = 0,
                               wordLen = 0;
...
inline std::string tabularize(const std::vector<std::string> &cells, std::string::size_type width, bool force)
{
    std::string rv;
    ...
    for (unsigned i = 0; i < cells.size(); i++)
    {
        ...
        if (((i % numCols) == (numCols - 1)) || (i == (cells.size() - 1)))
        {
            rv += '\n';
        }
    }
