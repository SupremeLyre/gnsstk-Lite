...
Exception::Exception(const std::string &errorText, const unsigned long &errId, const Severity &sever)
{
...
Exception::Exception(const char *errorText, const unsigned long &errId, const Severity &sever)
{
...
Exception::Exception(const Exception &e)
    : errorId(e.errorId), locations(e.locations), severity(e.severity), text(e.text), streamBuffer(e.streamBuffer)
{
}
...
Exception &Exception::addLocation(const ExceptionLocation &location)
{
    locations.push_back(location);
    return *this;
}

const ExceptionLocation Exception::getLocation(const size_t &index) const
{
