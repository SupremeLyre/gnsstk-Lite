...
ReferenceFrame asReferenceFrame(const std::string &s)
{
    ...
    if (s == "WGS84")
        return ReferenceFrame::WGS84;
    if (s == "WGS84(G730)")
        return ReferenceFrame::WGS84G730;
    if (s == "WGS84(G873)")
        return ReferenceFrame::WGS84G873;
    if (s == "WGS84(G1150)")
        return ReferenceFrame::WGS84G1150;
    if (s == "WGS84(G1674)")
        return ReferenceFrame::WGS84G1674;
    if (s == "WGS84(G1762)")
        return ReferenceFrame::WGS84G1762;
    if (s == "ITRF")
        return ReferenceFrame::ITRF;
    if (s == "ITRF(1994)")
        return ReferenceFrame::ITRF94;
    if (s == "ITRF(1996)")
        return ReferenceFrame::ITRF96;
    if (s == "ITRF(1997)")
        return ReferenceFrame::ITRF97;
    if (s == "ITRF(2000)")
        return ReferenceFrame::ITRF2000;
    if (s == "ITRF(2005)")
        return ReferenceFrame::ITRF2005;
    if (s == "ITRF(2008)")
        return ReferenceFrame::ITRF2008;
    if (s == "ITRF(2014)")
        return ReferenceFrame::ITRF2014;
    if (s == "PZ90")
        return ReferenceFrame::PZ90;
    if (s == "PZ90KGS")
        return ReferenceFrame::PZ90KGS;
    if (s == "CGCS2000")
        return ReferenceFrame::CGCS2000;
