...
namespace gnsstk
{
TimeSystemCorrection ::TimeSystemCorrection() : type(Unknown), frTS(TimeSystem::Unknown), toTS(TimeSystem::Unknown)
{
    init();
}

TimeSystemCorrection ::TimeSystemCorrection(std::string str)
{
    init();
    this->fromString(str);
}
...
void TimeSystemCorrection::init()
{
    A0 = 0.0;
    A1 = 0.0;
...
void TimeSystemCorrection ::fromString(const std::string &str)
{
...
bool TimeSystemCorrection ::convertTimeSystemToCorrType(TimeSystem src, TimeSystem tgt,
...
std::string TimeSystemCorrection ::asString() const
{
    switch (type)
    {
    case GPUT:
        return std::string("GPS to UTC");
    case GAUT:
        return std::string("GAL to UTC");
    case SBUT:
        return std::string("SBAS to UTC");
    case GLUT:
        return std::string("GLO to UTC");
    case GPGA:
        return std::string("GPS to GAL");
    case GLGP:
        return std::string("GLO to GPS");
    case QZGP:
        return std::string("QZS to GPS");
    case QZUT:
        return std::string("QZS to UTC");
    case BDUT:
        return std::string("BDT to UTC");
    case BDGP:
        return std::string("BDT to GPS");
    case IRUT:
        return std::string("IRN to UTC");
    case IRGP:
        return std::string("IRN to GPS");
    default:
        return std::string("ERROR");
    }
}

std::string TimeSystemCorrection ::asString4() const
{
    switch (type)
    {
    case GPUT:
        return std::string("GPUT");
    case GAUT:
        return std::string("GAUT");
    case SBUT:
        return std::string("SBUT");
    case GLUT:
        return std::string("GLUT");
    case GPGA:
        return std::string("GPGA");
    case GLGP:
        return std::string("GLGP");
    case QZGP:
        return std::string("QZGP");
    case QZUT:
        return std::string("QZUT");
    case BDUT:
        return std::string("BDUT");
    case BDGP:
        return std::string("BDGP");
    case IRUT:
        return std::string("IRUT");
    case IRGP:
        return std::string("IRGP");
    default:
        return std::string("ERROR");
    }
}

void TimeSystemCorrection ::dump(std::ostream &s) const
{
    s << "Time system correction for " << asString4() << ": " << asString() << std::scientific << std::setprecision(12);
    BDSWeekSecond bdt;
    GPSWeekSecond gps;
    CivilTime civ;
    switch (type)
    ...
    case GPUT:
        gps = refTime;
        s << ", A0 = " << A0 << ", A1 = " << A1 << ", RefTime = week/sow " << gps.week << "/" << int(gps.sow);
        break;
    case GAUT:
        gps = refTime;
        s << ", A0 = " << A0 << ", A1 = " << A1 << ", RefTime = week/sow " << gps.week << "/" << int(gps.sow);
    ...
    case GLUT:
        gps = refTime;
        s << ", -TauC = " << A0 << ", RefTime = week/sow " << gps.week << "/" << int(gps.sow);
        break;
    case GPGA:
        gps = refTime;
        s << ", A0G = " << A0 << ", A1G = " << A1 << ", RefTime = week/sow " << gps.week << "/" << int(gps.sow);
        break;
    case GLGP:
        civ = refTime;
        s << ", TauGPS = " << A0 << " sec, RefTime = yr/mon/day " << civ.year << "/" << civ.month << "/" << civ.day;
        break;
    case QZGP:
        gps = refTime;
        s << ", A0 = " << A0 << ", A1 = " << A1 << ", RefTime = week/sow " << gps.week << "/" << int(gps.sow);
    ...
    case BDUT:
        bdt = refTime;
        s << ", A0 = " << A0 << ", A1 = " << A1 << ", RefTime = week/sow " << bdt.week << "/" << int(bdt.sow);
        break;
    case BDGP:
        bdt = refTime;
        s << ", A0 = " << A0 << ", A1 = " << A1 << ", RefTime = week/sow " << bdt.week << "/" << int(bdt.sow);
...
bool TimeSystemCorrection ::isConverterFor(const TimeSystem &ts1, const TimeSystem &ts2) const
{
    if (ts1 == ts2)
    {
...
double TimeSystemCorrection ::Correction(const CommonTime &ct) const
{
    double corr(0.0), dt;
...
void TimeSystemCorrection ::fixTimeSystem()
{
    switch (type)
    {
