...
#ifndef GNSSTK_EngEphemeris_HPP
#define GNSSTK_EngEphemeris_HPP
...
class EngEphemeris : public EngNav
{
  public:
     ...
     * @return true if successful.
     */
    bool addIncompleteSF1Thru3(const uint32_t sf1[8], const uint32_t sf2[8], const uint32_t sf3[8],
                               const long sf1TransmitSOW, const int gpsWeek, const short PRN, const short track);
    ...
    EngEphemeris &loadData(const std::string satSysArg, const unsigned short tlm[3], const long how[3],
                           ...
                           const short l2pdata, const long Aodo, const double tgd, const double toc, const double Af2,
                           const double Af1, const double Af0, const short iode, const double crs, const double Dn,
                           const double m0, const double cuc, const double Ecc, const double cus, const double ahalf,
                           const double toe, const short fitInt, const double cic, const double Omega0,
                           const double cis, const double I0, const double crc, const double W, const double OmegaDot,
                           const double IDot);

    EngEphemeris &setSF1(unsigned tlm, double how, short asalert, short fullweek, short cflags, short acc,
                         short svhealth, short iodc, short l2pdata, double tgd, double toc, double Af2, double Af1,
                         double Af0, short Tracker, short prn);

    EngEphemeris &setSF2(unsigned tlm, double how, short asalert, short iode, double crs, double Dn, double m0,
                         double cuc, double Ecc, double cus, double ahalf, double toe, short fitInt);

    EngEphemeris &setSF3(unsigned tlm, double how, short asalert, double cic, double Omega0, double cis, double I0,
