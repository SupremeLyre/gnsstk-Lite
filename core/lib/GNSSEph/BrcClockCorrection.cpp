...
BrcClockCorrection::BrcClockCorrection() noexcept
{
    dataLoaded = false;
...
BrcClockCorrection::BrcClockCorrection(const std::string satSysArg, const ObsID obsIDArg, const short PRNIDArg,
                                       const CommonTime TocArg, const CommonTime TopArg, const short URAocArg,
                                       const short URAoc1Arg, const short URAoc2Arg, const bool healthyArg,
                                       const double af0Arg, const double af1Arg, const double af2Arg)
{
    loadData(satSysArg, obsIDArg, PRNIDArg, TocArg, TopArg, URAocArg, URAoc1Arg, URAoc2Arg, healthyArg, af0Arg, af1Arg,
             af2Arg);
}
...
bool BrcClockCorrection::operator==(const BrcClockCorrection &right) const noexcept
{
    // EngNav has no data
    return ((dataLoaded == right.dataLoaded) && (satSys == right.satSys) && (obsID == right.obsID) &&
            (PRNID == right.PRNID) && (Toc == right.Toc) && (Top == right.Top) && (URAoc == right.URAoc) &&
            (URAoc1 == right.URAoc1) && (URAoc2 == right.URAoc2) && (healthy == right.healthy) && (af0 == right.af0) &&
            (af1 == right.af1) && (af2 == right.af2));
}

void BrcClockCorrection::loadData(const std::string satSysArg, const ObsID obsIDArg, const short PRNIDArg,
                                  const CommonTime TocArg, const short URAocArg, const bool healthyArg,
                                  const double af0Arg, const double af1Arg, const double af2Arg)
{
