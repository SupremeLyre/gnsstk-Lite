...
SP3SatID ::SP3SatID(int p, SatelliteSystem s) noexcept : SatID(p, s)
{
    validate();
}

char SP3SatID ::systemChar() const noexcept
{
    switch (system)
    {
...
std::string SP3SatID ::systemString() const noexcept
{
    switch (system)
    {
    case SatelliteSystem::GPS:
...
void SP3SatID ::fromString(const std::string s)
{
    char c;
...
std::string SP3SatID ::toString() const noexcept
{
    ...
    oss << systemChar() << std::setw(2) << sp3ID;
    return oss.str();
}

void SP3SatID ::validate()
{
    switch (system)
    {
    case SatelliteSystem::GPS:
