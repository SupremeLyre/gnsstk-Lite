...
class PackedNavBits
{
  public:
    ...
    /// explicit constructor
    PackedNavBits(const SatID &satSysArg, const ObsID &obsIDArg, const std::string rxString,
                  const CommonTime &transmitTimeArg);

    /// explicit constructor
    PackedNavBits(const SatID &satSysArg, const ObsID &obsIDArg, const NavID &navIDArg, const std::string rxString,
                  const CommonTime &transmitTimeArg);

    /// explicit constructor
    PackedNavBits(const SatID &satSysArg, const ObsID &obsIDArg, const NavID &navIDArg, const std::string rxString,
                  const CommonTime &transmitTimeArg, unsigned numBits, bool fillValue);

    PackedNavBits(
        const PackedNavBits &right); // Copy constructor
    ...
    */
    ...
    unsigned long asUnsignedLong(const unsigned startBits[], const unsigned numBits[], const unsigned len,
     ...
     */
    unsigned long asUnsignedLong(const unsigned startBit1, const unsigned numBits1, const unsigned startBit2,
     ...
     * @return The decoded value.
     */
    long asLong(const unsigned startBit1, const unsigned numBits1, const unsigned startBit2, const unsigned numBits2,
                const int scale) const;

    /* Unpack a split unsigned double */
    double asUnsignedDouble(const unsigned startBits[], const unsigned numBits[], const unsigned len,
     ...
     * @return The decoded value.
     */
    double asUnsignedDouble(const unsigned startBit1, const unsigned numBits1, const unsigned startBit2,
                            const unsigned numBits2, const int power2) const;

    /* Unpack a split signed double */
    double asSignedDouble(const unsigned startBits[], const unsigned numBits[], const unsigned len,
                          const int power2) const;
     ...
     * @return The decoded value.
     */
    static double asUnsignedDouble(const std::vector<unsigned> &startBits, const std::vector<unsigned> &numBits,
     ...
     * @return The decoded value.
     */
    static double asSignedDouble(const std::vector<unsigned> &startBits, const std::vector<unsigned> &numBits,
                                 const std::vector<unsigned> &whichSF, const std::vector<PackedNavBitsPtr> &bits,
                                 const int power2);
     ...
     * @return The decoded value.
     */
    double asSignedDouble(const unsigned startBit1, const unsigned numBits1, const unsigned startBit2,
                          const unsigned numBits2, const int power2) const;

    /* Unpack a split double with units of semicircles */
    double asDoubleSemiCircles(const unsigned startBits[], const unsigned numBits[], const unsigned len,
                               const int power2) const;
     ...
     * @return The decoded value.
     */
    double asDoubleSemiCircles(const unsigned startBit1, const unsigned numBits1, const unsigned startBit2,
                               const unsigned numBits2, const int power2) const;
     ...
     */
    template <class It> void addBitVec(It begin, It end)
    {
    ...
    template <size_t N> void addBitset(const std::bitset<N> &newbits)
    {
     ...
     */
    int outputPackedBits(std::ostream &s = std::cout, const short numPerLine = 4, const char delimiter = ' ',
     ...
     */
    bool match(const PackedNavBits &right, const short startBit = 0, const short endBit = -1,
