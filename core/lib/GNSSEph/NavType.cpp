...
std::string asString(NavType e) noexcept
{
    ...
    case NavType::GPSCNAVL5:
        return "GPS_CNAV_L5";
    case NavType::GPSCNAV2:
        return "GPS_CNAV2";
    case NavType::GPSMNAV:
        return "GPS_MNAV";
    case NavType::BeiDou_D1:
        return "Beidou_D1";
    case NavType::BeiDou_D2:
        return "Beidou_D2";
    case NavType::GloCivilF:
        return "GloCivilF";
    case NavType::GloCivilC:
        return "GloCivilC";
    case NavType::GalFNAV:
        return "GalFNAV";
    case NavType::GalINAV:
        return "GalINAV";
    case NavType::IRNSS_SPS:
        return "IRNSS_SPS";
    default:
        return "???";
    } // switch (e)
