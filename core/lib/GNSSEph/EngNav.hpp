...
class EngNav
{
  public:
     ...
     */
    static bool getNMCTValidity(const uint32_t sf2[10], unsigned howWeek, uint32_t &aodo, CommonTime &tnmct,
    ...
    {
        return getNMCTValidity(sf2, howWeek, meta.aodo, meta.tnmct, meta.toe, meta.tot);
    }
