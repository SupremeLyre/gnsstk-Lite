...
//
//==============================================================================
#ifndef GNSSTK_PNBGALFNAVDATAFACTORY_HPP
#define GNSSTK_PNBGALFNAVDATAFACTORY_HPP
...
class PNBGalFNavDataFactory : public PNBNavDataFactory
{
  public:
     ...
     */
    bool processAlmOrb(const std::vector<PackedNavBitsPtr> &almPage, GalFNavAlm *alm, GalFNavHealth *hp1, int ptA,
                       int ptB, int asiSVID, int asbSVID, int asidAhalf, int asbdAhalf, int asiEcc, int asbEcc,
                       int asiw, int asbw, int asidi, int asbdi, int asiOMEGAdot, int asbOMEGAdot, int asiM0, int asbM0,
...
#endif // GNSSTK_PNBGALFNAVDATAFACTORY_HPP
