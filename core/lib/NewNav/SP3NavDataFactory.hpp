...
class SP3NavDataFactory : public NavDataFactoryWithStoreFile
{
  public:
    ...
    GNSSTK_EXPORT static const ObsID oidGPS, oidGalileo, oidQZSS, oidGLONASS, oidBeiDou;
    /// Generic NavTypes for each GNSS.
    GNSSTK_EXPORT static const NavType ntGPS, ntGalileo, ntQZSS, ntGLONASS, ntBeiDou;
    ...
    bool find(const NavMessageID &nmid, const CommonTime &when, NavDataPtr &navOut, SVHealth xmitHealth,
              NavValidityType valid, NavSearchOrder order) override;
    ...
    {
        checkDataGapPos = true;
        gapIntervalPos = interval;
    }
    ...
    {
        checkDataGapClk = true;
        gapIntervalClk = interval;
    }
    ...
    {
        checkIntervalPos = true;
        maxIntervalPos = interval;
    }
    ...
    {
        checkIntervalClk = true;
        maxIntervalClk = interval;
    }
  ...
  private:
    ...
    bool findIterator(NavSatMap::iterator &sati, const CommonTime &when, NavDataPtr &navData, unsigned halfOrder,
                      bool findEph, bool checkDataGap, bool checkInterval, double gapInterval, double maxInterval);
    ...
    void interpolateEph(const NavMap::iterator &ti1, const NavMap::iterator &ti3, const CommonTime &when,
                        NavDataPtr &navData);
     ...
     * @param[in,out] navData The pre-allocated NavDataPtr object
     *   that stores the interpolated OrbitDataSP3. */
    void interpolateClk(const NavMap::iterator &ti1, const NavMap::iterator &ti3, const CommonTime &when,
                        NavDataPtr &navData);
