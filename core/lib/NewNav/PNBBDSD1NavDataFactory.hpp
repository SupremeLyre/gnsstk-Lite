...
//
//==============================================================================
#ifndef GNSSTK_PNBBDSD1NAVDATAFACTORY_HPP
#define GNSSTK_PNBBDSD1NAVDATAFACTORY_HPP
...
class PNBBDSD1NavDataFactory : public PNBNavDataFactory
{
  public:
     ...
     * @return false on error. */
    bool processAlm(unsigned long sfid, unsigned pnum, const PackedNavBitsPtr &navIn, NavDataPtrList &navOut);
  ...
  protected:
     ...
     *   of the health bits. */
    void makeHealth(const PackedNavBitsPtr &navIn, NavDataPtrList &navOut, unsigned long subjID, unsigned startBit1,
                    unsigned numBits1, unsigned startBit2 = 0, unsigned numBits2 = 0);
...
#endif // GNSSTK_PNBBDSD1NAVDATAFACTORY_HPP
