...
//
//==============================================================================
#ifndef GNSSTK_BDSD1NAVISC_HPP
#define GNSSTK_BDSD1NAVISC_HPP
...
class BDSD1NavISC : public InterSigCorr
{
  public:
    ...
    {
        return std::make_shared<BDSD1NavISC>(*this);
    }
