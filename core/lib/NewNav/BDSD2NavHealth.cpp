...
namespace gnsstk
{
BDSD2NavHealth ::BDSD2NavHealth() : isAlmHealth(true), satH1(true), svHealth(0xff)
{
    weekFmt = "%4D(%4e)";
    msgLenSec = 6.0;
}

SVHealth BDSD2NavHealth ::getHealth() const
{
    if (isAlmHealth)
    {
...
void BDSD2NavHealth ::dump(std::ostream &s, DumpDetail dl) const
{
