...
namespace gnsstk
{
KlobucharIonoNavData ::KlobucharIonoNavData() : alpha{0, 0, 0, 0}, beta{0, 0, 0, 0}
{
}

void KlobucharIonoNavData ::dump(std::ostream &s, DumpDetail dl) const
{
    ...
    s << endl
      ...
      << "alpha[2]    " << setw(16) << alpha[2] << " sec/semi-circle**2" << endl
      << "alpha[3]    " << setw(16) << alpha[3] << " sec/semi-circle**3" << endl
      << "beta[0]     " << setw(16) << beta[0] << " sec" << endl
      << "beta[1]     " << setw(16) << beta[1] << " sec/semi-circle" << endl
      << "beta[2]     " << setw(16) << beta[2] << " sec/semi-circle**2" << endl
      << "beta[3]     " << setw(16) << beta[3] << " sec/semi-circle**3" << endl;

    s.flags(oldFlags);
}

double KlobucharIonoNavData ::getIonoCorr(const CommonTime &when, const Position &rxgeo, const Position &svgeo,
