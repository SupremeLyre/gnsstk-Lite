...
namespace gnsstk
{
bool NavDataFactory ::isPresent(const NavMessageID &nmid, const CommonTime &fromTime, const CommonTime &toTime)
{
    ...
    while (true)
    {
        ...
        //           << std::endl;
        if (find(nmid, t, junk, SVHealth::Any, NavValidityType::Any, NavSearchOrder::User))
        {
            return true;
        }
...
std::set<SatID> NavDataFactory ::getIndexSet(const CommonTime &fromTime, const CommonTime &toTime) const
{
...
std::set<SatID> NavDataFactory ::getIndexSet(NavMessageType nmt, const CommonTime &fromTime,
...
std::string NavDataFactory ::getClassName() const
{
