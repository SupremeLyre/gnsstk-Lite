...
namespace gnsstk
{
YumaNavDataFactory ::YumaNavDataFactory()
{
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::CA, NavType::GPSLNAV));
}

bool YumaNavDataFactory ::loadIntoMap(const std::string &filename, NavMessageMap &navMap, NavNearMessageMap &navNearMap,
                                      OffsetCvtMap &ofsMap)
{
...
bool YumaNavDataFactory ::process(const std::string &filename, NavDataFactoryCallback &cb)
{
    bool rv = true;
...
std::string YumaNavDataFactory ::getFactoryFormats() const
{
...
bool YumaNavDataFactory ::convertToOrbit(const YumaData &navIn, NavDataPtr &navOut)
{
    bool rv = true;
    GPSLNavAlm *gps;
...
bool YumaNavDataFactory ::convertToHealth(const YumaData &navIn, NavDataPtr &healthOut)
{
    bool rv = true;
    GPSLNavHealth *gps;
...
void YumaNavDataFactory ::fillNavData(const YumaData &navIn, NavDataPtr &navOut)
{
    // NavData
