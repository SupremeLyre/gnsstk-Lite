  ...
  private:
    ...
    class Uncorrected : public Perturbations
    {
      public:
        ...
        inline void setData(const GLOCNavAlm &alm, double Tdr, double n, double Deltatpr);
    ...
    class Deltas : public Perturbations
    {
      ...
      private:
         ...
         * @copydetails setData() */
        inline void setdeltalambda(double B, double Lk, const Uncorrected &uncor);
    ...
    class Corrected : public Perturbations
    {
      public:
        ...
        inline void setData(double L, const Uncorrected &uncor, const Deltas &delta1, const Deltas &delta2);
    ...
    class NumberCruncher
    {
      public:
        NumberCruncher();
        inline Xvt getXvt(const GLOCNavAlm &alm, const gnsstk::CommonTime &toi);
      ...
      private:
        ...
        inline void setDeltatpr(const gnsstk::CommonTime &almTime, const gnsstk::CommonTime &ti);
