...
void GalFNavHealth ::dump(std::ostream &s, DumpDetail dl) const
{
...
SVHealth GalFNavHealth ::getHealth() const
{
    return GalINavHealth::galHealth(sigHealthStatus, dataValidityStatus, sisaIndex);
}
} // namespace gnsstk
