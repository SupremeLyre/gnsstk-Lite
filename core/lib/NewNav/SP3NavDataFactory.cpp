...
namespace gnsstk
{
const ObsID SP3NavDataFactory::oidGPS(ObservationType::NavMsg, CarrierBand::L1, TrackingCode::CA, 0, 0);
const ObsID SP3NavDataFactory::oidGalileo(ObservationType::NavMsg, CarrierBand::L5, TrackingCode::E5aI, 0, 0);
const ObsID SP3NavDataFactory::oidQZSS(ObservationType::NavMsg, CarrierBand::L1, TrackingCode::CA, 0, 0);
const ObsID SP3NavDataFactory::oidGLONASS(ObservationType::NavMsg, CarrierBand::G1, TrackingCode::Standard);
const ObsID SP3NavDataFactory::oidBeiDou(ObservationType::NavMsg, CarrierBand::B1, TrackingCode::B1I, 0, 0);
...
SP3NavDataFactory ::SP3NavDataFactory()
    : storeTimeSystem(TimeSystem::Any), checkDataGapPos(false), gapIntervalPos(0.0), checkDataGapClk(false),
      gapIntervalClk(0.0), checkIntervalPos(false), maxIntervalPos(0.0), checkIntervalClk(false), maxIntervalClk(0.0),
      useSP3clock(true), rejectBadPosFlag(true), rejectBadClockFlag(true), rejectPredPosFlag(false),
      rejectPredClockFlag(false), interpType(ClkInterpType::Lagrange), halfOrderClk(5), halfOrderPos(5),
      initOrbitDataVal(0.0)
{
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::BeiDou, CarrierBand::B1, TrackingCode::B1I, NavType::BeiDou_D1));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::BeiDou, CarrierBand::B1, TrackingCode::B1I, NavType::BeiDou_D2));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::BeiDou, CarrierBand::B3, TrackingCode::B3I, NavType::BeiDou_D1));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::BeiDou, CarrierBand::B3, TrackingCode::B3I, NavType::BeiDou_D2));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::BeiDou, CarrierBand::B2, TrackingCode::B2I, NavType::BeiDou_D1));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::BeiDou, CarrierBand::B2, TrackingCode::B2I, NavType::BeiDou_D2));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::CA, NavType::GPSLNAV));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::L1CD, NavType::GPSCNAV2));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::NSCA, NavType::GPSLNAV));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::Y, NavType::GPSLNAV));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::L2CML, NavType::GPSCNAVL2));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::L2CM, NavType::GPSCNAVL2));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::Y, NavType::GPSLNAV));
    supportedSignals.insert(NavSignalID(SatelliteSystem::GPS, CarrierBand::L5, TrackingCode::L5I, NavType::GPSCNAVL5));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::MD, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::MDP, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::MPA, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::Mprime, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L1, TrackingCode::MprimePA, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::MD, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::MDP, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::MPA, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::Mprime, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::GPS, CarrierBand::L2, TrackingCode::MprimePA, NavType::GPSMNAV, 0, 0));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Galileo, CarrierBand::L5, TrackingCode::E5aI, NavType::GalFNAV));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Galileo, CarrierBand::E5b, TrackingCode::E5bI, NavType::GalINAV));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Galileo, CarrierBand::L1, TrackingCode::E1B, NavType::GalINAV));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Glonass, CarrierBand::G1, TrackingCode::Standard, NavType::GloCivilF));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Glonass, CarrierBand::G2, TrackingCode::Standard, NavType::GloCivilF));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Glonass, CarrierBand::G3, TrackingCode::G3TestData, NavType::GloCivilC));
    supportedSignals.insert(
        NavSignalID(SatelliteSystem::Glonass, CarrierBand::G3, TrackingCode::L3OCD, NavType::GloCivilC));
    supportedSignals.insert(NavSignalID(SatelliteSystem::QZSS, CarrierBand::L1, TrackingCode::CA, NavType::GPSLNAV));
    supportedSignals.insert(NavSignalID(SatelliteSystem::QZSS, CarrierBand::L5, TrackingCode::L5I, NavType::GPSCNAVL5));
}

bool SP3NavDataFactory ::find(const NavMessageID &nmid, const CommonTime &when, NavDataPtr &navOut, SVHealth xmitHealth,
...
bool SP3NavDataFactory ::findGeneric(NavMessageType nmt, const NavSatelliteID &nsid, const CommonTime &when,
                                     NavDataPtr &navData)
{
    DEBUGTRACE_FUNCTION();
    ...
    if (dataIt == data.end())
    {
        DEBUGTRACE("NO data for nav message type " << StringUtils::asString(nmt));
    ...
    if (!nsid.isWild())
    {
        ...
        return findIterator(sati, when, navData, halfOrder, findEph, checkDataGap, checkInterval, gapInterval,
                            maxInterval);
    }
    else
    {
        ...
        bool rv = false;
        for (auto sati = dataIt->second.begin(); sati != dataIt->second.end(); sati++)
        {
            if (sati->first != nsid)
                continue; // skip non matches
            rv = findIterator(sati, when, navData, halfOrder, findEph, checkDataGap, checkInterval, gapInterval,
                              maxInterval);
            if (rv)
                break;
        }
...
bool SP3NavDataFactory ::findIterator(NavSatMap::iterator &sati, const CommonTime &when, NavDataPtr &navData,
                                      unsigned halfOrder, bool findEph, bool checkDataGap, bool checkInterval,
                                      double gapInterval, double maxInterval)
{
    ...
    else
    {
        ...
        if ((tiTmp != sati->second.end()) && (tiTmp->second->timeStamp == when))
        {
            exactMatch = true;
            offs = 1;
        }
        ...
        if (checkDataGap && (tiTmp != sati->second.end()) && ((ti2->first - tiTmp->first) > gapInterval))
        {
        ...
        if (!giveUp)
        {
            while (true)
            {
                ...
                if ((ti1 == sati->second.end()) || ((ti3 == sati->second.end()) && (count <= halfOrder - offs)) ||
                    ((ti1 == sati->second.begin()) && (count <= halfOrder + offs)))
                {
    ...
    if (ti2->second->timeStamp == when)
    {
        ...
        if (!navData)
        {
            OrbitDataSP3 *stored = dynamic_cast<OrbitDataSP3 *>(ti2->second.get());
        ...
        {
            OrbitDataSP3 *stored = dynamic_cast<OrbitDataSP3 *>(ti2->second.get());
            OrbitDataSP3 *navOut = dynamic_cast<OrbitDataSP3 *>(navData.get());
            if (findEph)
            {
    ...
    else
    {
        ...
        DEBUGTRACE("OK, have interval " << printTime(ti1->first, "" + dts) << " <= " << printTime(when, "" + dts)
...
bool SP3NavDataFactory ::addDataSource(const std::string &source)
{
    DEBUGTRACE_FUNCTION();
    gnsstk::NavDataFactoryStoreCallback cb(this, data, nearestData, offsetData);
    return process(source, cb);
}

bool SP3NavDataFactory ::process(const std::string &filename, NavDataFactoryCallback &cb)
{
    DEBUGTRACE_FUNCTION();
    bool rv = true;
    ...
    try
    {
        ...
        if ((head.timeSystem != TimeSystem::Any) && (head.timeSystem != TimeSystem::Unknown))
        {
            ...
            else if (storeTimeSystem != head.timeSystem)
            {
                ...
                cerr << "Time system mismatch in SP3 data, " << gnsstk::StringUtils::asString(storeTimeSystem)
                     << " (store) != " << gnsstk::StringUtils::asString(head.timeSystem) << " (file)" << endl;
                return false;
            }
        }
        ...
        while (is)
        {
            ...
            if (data.RecType != '*')
            {
                if (rejectBadPosFlag && (data.x[0] == 0.0) || (data.x[1] == 0.0) || (data.x[2] == 0.0))
                {
...
bool SP3NavDataFactory ::addRinexClock(const std::string &source, NavDataFactoryCallback &cb)
{
    bool rv = true;
    ...
    try
    {
        ...
        while (is)
        {
            ...
            if (data.datatype == std::string("AS"))
            {
                ...
                OrbitDataSP3 *gps;
                NavDataPtr clk = std::make_shared<OrbitDataSP3>(initOrbitDataVal);
...
std::string SP3NavDataFactory ::getFactoryFormats() const
{
    if (procNavTypes.empty() || (procNavTypes.count(NavMessageType::Ephemeris) > 0) ||
...
bool SP3NavDataFactory ::convertToOrbit(const SP3Header &head, const SP3Data &navIn, bool isC, NavDataPtr &navOut,
                                        double initVal)
{
    DEBUGTRACE_FUNCTION();
    OrbitDataSP3 *gps;
    ...
    case 'P':
        ...
        for (unsigned i = 0; i < 3; i++)
        {
            ...
            else if (isC && (navIn.sig[i] >= 0))
            {
                ...
                DEBUGTRACE("pow(head.basePV,navIn.sig[" << i << "] = " << gps->posSig[i]);
            }
        }
    ...
    DEBUGTRACE("setting reference frame using time " << gnsstk::printTime(head.time, dts) << " "
                                                     << StringUtils::asString(head.timeSystem));
    gps->frame = RefFrame(gps->coordSystem, head.time);
    return true;
}

bool SP3NavDataFactory ::convertToClock(const SP3Header &head, const SP3Data &navIn, bool isC, NavDataPtr &clkOut,
                                        double initVal)
{
    bool rv = true;
    OrbitDataSP3 *gps;
...
bool SP3NavDataFactory ::store(bool process, NavDataFactoryCallback &cb, NavDataPtr &obj)
{
    DEBUGTRACE_FUNCTION();
...
void SP3NavDataFactory ::interpolateEph(const NavMap::iterator &ti1, const NavMap::iterator &ti3,
                                        const CommonTime &when, NavDataPtr &navData)
{
    DEBUGTRACE_FUNCTION();
    DEBUGTRACE("start interpolating ephemeris, distance = " << std::distance(ti1, ti3));
    std::vector<double> tdata(2 * halfOrderPos);
    std::vector<std::vector<double>> posData(3), posSigData(3), velData(3), velSigData(3), accData(3), accSigData(3);
    ...
    for (ti2 = ti1, idx = 0; ti2 != ti3; ++ti2, ++idx)
    {
        ...
        if ((idx == halfOrderPos) && (ti2->second->timeStamp == when))
            isExact = true;
        OrbitDataSP3 *nav = dynamic_cast<OrbitDataSP3 *>(ti2->second.get());
        DEBUGTRACE("nav=" << nav);
        // ti2->second->dump(cerr, DumpDetail::Full);
        for (unsigned i = 0; i < 3; i++)
        {
            DEBUGTRACE("i=" << i);
            DEBUGTRACE(posData.size() << " " << velData.size() << " " << accData.size());
            DEBUGTRACE(nav->pos.size() << " " << nav->vel.size() << " " << nav->acc.size());
    ...
    if (DebugTrace::enabled)
    {
        for (unsigned i = 0; i < tdata.size(); i++)
        {
            ...
            DEBUGTRACE("P=" << posData[0][i] << " " << posData[1][i] << " " << posData[2][i]);
            DEBUGTRACE("V=" << velData[0][i] << " " << velData[1][i] << " " << velData[2][i]);
            DEBUGTRACE("A=" << accData[0][i] << " " << accData[1][i] << " " << accData[2][i]);
        }
    }
    DEBUGTRACE("haveVelocity=" << haveVel << "  haveAcceleration=" << haveAcc);
    ...
    for (unsigned i = 0; i < 3; i++)
    {
        if (haveVel && haveAcc)
        {
            ...
            DEBUGTRACE("!isExact sigP[" << i << "][" << Nhi << "] = " << posSigData[i][Nhi]);
            DEBUGTRACE("         sigP[" << i << "][" << Nlow << "] = " << posSigData[i][Nlow]);
            DEBUGTRACE("         sigV[" << i << "][" << Nhi << "] = " << velSigData[i][Nhi]);
            DEBUGTRACE("         sigV[" << i << "][" << Nlow << "] = " << velSigData[i][Nlow]);
            DEBUGTRACE("         sigA[" << i << "][" << Nhi << "] = " << accSigData[i][Nhi]);
            DEBUGTRACE("         sigA[" << i << "][" << Nlow << "] = " << accSigData[i][Nlow]);
            if (!isExact)
            {
                osp3->posSig[i] = RSS(posSigData[i][halfOrderPos - 1], posSigData[i][halfOrderPos]);
                osp3->velSig[i] = RSS(velSigData[i][halfOrderPos - 1], velSigData[i][halfOrderPos]);
                osp3->accSig[i] = RSS(accSigData[i][halfOrderPos - 1], accSigData[i][halfOrderPos]);
                DEBUGTRACE("1 RSS(posSigData[" << i << "][" << (halfOrderPos - 1) << "],posSigData[" << i << "]["
                                               << halfOrderPos << "]) = " << osp3->posSig[i]);
            }
        }
        else if (haveVel && !haveAcc)
        {
            osp3->pos[i] = LagrangeInterpolation(tdata, posData[i], dt, err);
            LagrangeInterpolation(tdata, velData[i], dt, osp3->vel[i], osp3->acc[i]);
            osp3->acc[i] *= 0.1;
            unsigned Nhi = halfOrderPos, Nlow = halfOrderPos - 1;
            DEBUGTRACE("!isExact sigP[" << i << "][" << Nhi << "] = " << posSigData[i][Nhi]);
            DEBUGTRACE("         sigP[" << i << "][" << Nlow << "] = " << posSigData[i][Nlow]);
            ...
            DEBUGTRACE("2 RSS(posSigData[" << i << "][" << (halfOrderPos - 1) << "],posSigData[" << i << "]["
                                           << halfOrderPos << "]) = " << osp3->posSig[i]);
        }
        else
        {
            // have position, must derive velocity and acceleration
            LagrangeInterpolation(tdata, posData[i], dt, osp3->pos[i], osp3->vel[i]);
            ...
            DEBUGTRACE("3 RSS(posSigData[" << i << "][" << (halfOrderPos - 1) << "],posSigData[" << i << "]["
                                           << halfOrderPos << "]) = " << osp3->posSig[i]);
        }
    } // for (unsigned i = 0; i < 3; i++)
    if (DebugTrace::enabled)
    {
        for (unsigned i = 0; i < 3; i++)
        {
            DEBUGTRACE("pos[" << i << "]=" << osp3->pos[i] << "  vel[" << i << "]=" << osp3->vel[i] << "  acc[" << i
                              << "]=" << osp3->acc[i]);
        }
    }
}

void SP3NavDataFactory ::interpolateClk(const NavMap::iterator &ti1, const NavMap::iterator &ti3,
                                        const CommonTime &when, NavDataPtr &navData)
{
    DEBUGTRACE_FUNCTION();
    DEBUGTRACE("start interpolating clock, distance = " << std::distance(ti1, ti3));
    unsigned Nhi = halfOrderClk, Nlow = halfOrderClk - 1;
    std::vector<double> tdata(2 * halfOrderClk), biasData(2 * halfOrderClk), biasSigData(2 * halfOrderClk),
        driftData(2 * halfOrderClk), driftSigData(2 * halfOrderClk), drRateData(2 * halfOrderClk),
        drRateSigData(2 * halfOrderClk);
    CommonTime firstTime(ti1->second->timeStamp);
    // This flag is only used to decide whether to compute sigmas
    // or use existing ones.  It is expected that for exact time
    // matches, navData will already have any sigma data filled
    ...
    double dt = when - firstTime, err, slope, slopedt = tdata[Nhi] - tdata[Nlow];
    OrbitDataSP3 *osp3 = dynamic_cast<OrbitDataSP3 *>(navData.get());
    DEBUGTRACE(setprecision(20) << "  dt=" << dt);
    gnsstk::InvalidRequest unkType("Clock interpolation type " + StringUtils::asString(static_cast<int>(interpType)) +
                                   " is not supported");
    if (haveDrift)
    {
        switch (interpType)
    ...
    else
    {
        ...
        {
        case ClkInterpType::Lagrange:
            LagrangeInterpolation(tdata, biasData, dt, osp3->clkBias, osp3->clkDrift);
            break;
        case ClkInterpType::Linear:
            slope = (biasData[Nhi] - biasData[Nlow]) / slopedt;
            osp3->clkDrift = slope;
...
bool SP3NavDataFactory ::setSignal(const SatID &sat, NavMessageID &signal)
{
    bool rv = true;
    signal.sat = sat;
    signal.xmitSat = sat;
    ...
    default:
        ...
        signal.obs = ObsID(ObservationType::NavMsg, CarrierBand::Unknown, TrackingCode::Unknown);
...
bool SP3NavDataFactory ::transNavMsgID(const NavMessageID &nmidIn, NavMessageID &nmidOut)
{
    nmidOut = nmidIn; // copy all the original data first.
    return setSignal(nmidIn.sat, nmidOut);
}

void SP3NavDataFactory ::useRinexClockData(bool useRC)
{
...
void SP3NavDataFactory ::setClockInterpOrder(unsigned int order)
{
...
void SP3NavDataFactory ::setClockLagrangeInterp()
{
    interpType = ClkInterpType::Lagrange;
    halfOrderClk = 5;
}

void SP3NavDataFactory ::setClockLinearInterp()
{
    interpType = ClkInterpType::Linear;
    halfOrderClk = 1;
}

double SP3NavDataFactory ::getPositionTimeStep(const SatID &sat) const
{
    NavMessageID key(NavSatelliteID(sat), NavMessageType::Ephemeris);
    return nomTimeStep(key);
}

double SP3NavDataFactory ::getClockTimeStep(const SatID &sat) const
{
    NavMessageID key(NavSatelliteID(sat), NavMessageType::Clock);
    return nomTimeStep(key);
}

double SP3NavDataFactory ::nomTimeStep(const NavMessageID &nmid) const
{
    DEBUGTRACE_FUNCTION();
    ...
    if (dataIt == data.end())
    {
        DEBUGTRACE("NO data for nav message type " << StringUtils::asString(nmid.messageType));
        for (const auto dit : data)
        {
            DEBUGTRACE("found: " << StringUtils::asString(dit.first));
        }
...
void SP3NavDataFactory ::dumpConfig(std::ostream &s) const
{
    ...
    static const std::string fmt("%4F %w %10.3g %4Y/%02m/%02d %2H:%02M:%02S %P");
    s << "Dump SP3NavDataFactory:" << endl
      << (rejectBadPosFlag ? " Reject" : " Do not reject") << " bad positions." << endl
      << (rejectBadClockFlag ? " Reject" : " Do not reject") << " bad clocks." << endl
      << (rejectPredPosFlag ? " Reject" : " Do not reject") << " predicted positions." << endl
      << (rejectPredClockFlag ? " Reject" : " Do not reject") << " predicted clocks." << endl
      << "Position data:" << endl
      << " Interpolation is Lagrange, of order " << getPositionInterpOrder() << " (" << halfOrderPos
      << " points on each side)" << endl
      << "  Data stored for " << numSatellites() << " satellites" << endl
      << "  Time span of data: "
      << "  Initial time is " << printTime(initialTime, fmt) << endl;
    if ((initialTime == CommonTime::END_OF_TIME) || (finalTime == CommonTime::BEGINNING_OF_TIME))
    {
        s << "(there are no time limits)" << endl;
    }
    else
    {
        s << " FROM " << printTime(initialTime, fmt) << " TO " << printTime(finalTime, fmt) << endl;
    }
    ...
    if (checkDataGapPos)
    {
        s << "yes; gap interval is " << fixed << setprecision(2) << gapIntervalPos;
    }
    else
    {
        s << "no";
    ...
    if (checkIntervalPos)
    {
        s << "yes; max interval is " << fixed << setprecision(2) << maxIntervalPos;
    }
    else
    {
        s << "no";
    }
    s << endl << "Clock data:" << endl << " Interpolation is ";
    switch (interpType)
    {
    case ClkInterpType::Linear:
        s << "Linear." << endl;
        break;
    case ClkInterpType::Lagrange:
        s << "Lagrange, of order " << getClockInterpOrder() << " (" << halfOrderClk << " points on each side)" << endl;
        break;
    default:
        s << "???" << endl;
        break;
    ...
    if (checkDataGapClk)
    {
        s << "yes; gap interval is " << fixed << setprecision(2) << gapIntervalClk;
    }
    else
    {
        s << "no";
    ...
    if (checkIntervalClk)
    {
        s << "yes; max interval is " << fixed << setprecision(2) << maxIntervalClk;
    }
    else
    {
        s << "no";
    }
    s << endl << "End dump SP3NavDataFactory." << endl;
}
