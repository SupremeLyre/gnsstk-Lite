...
namespace gnsstk
{
inline void GLOCNavAlm::Uncorrected ::setData(const GLOCNavAlm &alm, double Tdr, double n, double Deltatpr)
{
    seti(alm.deltai);
...
inline void GLOCNavAlm::Uncorrected ::seti(double DeltaiA)
{
    i = ((iav / 180.0) + DeltaiA) * gnsstk::PI;
}

inline void GLOCNavAlm::Uncorrected ::seta(double epsilonA, double omegaA, double Tdr)
{
...
inline void GLOCNavAlm::Uncorrected ::setp(double epsilonA)
{
    p = a * (1.0 - epsilonA * epsilonA);
}

inline void GLOCNavAlm::Uncorrected ::sethl(double epsilonA)
{
    h = epsilonA * sin(omega);
    l = epsilonA * cos(omega);
}

inline void GLOCNavAlm::Uncorrected ::setlambda(double lambdaA, double n, double Deltatpr)
{
    double ev = ae / p;
...
inline void GLOCNavAlm::Uncorrected ::setomega(double omegaA, double n, double Deltatpr)
{
    double ev = ae / p;
