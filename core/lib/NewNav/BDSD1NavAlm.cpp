...
namespace gnsstk
{
BDSD1NavAlm ::BDSD1NavAlm() : pnum(0xff), deltai(0.0), toa(0.0), healthBits(0xffff), isDefault(false)
{
    signal.messageType = NavMessageType::Almanac;
    msgLenSec = 6.0;
}

bool BDSD1NavAlm ::validate() const
{
    return !isDefault && BDSD1NavData::validate();
}

void BDSD1NavAlm ::fixFit()
{
    beginFit = xmitTime;
...
void BDSD1NavAlm ::dumpSVStatus(std::ostream &s) const
{
