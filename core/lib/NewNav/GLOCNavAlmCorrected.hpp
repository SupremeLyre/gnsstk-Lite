...
namespace gnsstk
{
inline void GLOCNavAlm::Corrected ::setData(double L, const Uncorrected &uncor, const Deltas &delta1,
                                            const Deltas &delta2)
{
...
inline Xvt GLOCNavAlm::Corrected ::getXvt(const gnsstk::CommonTime &toi)
{
    Xvt rv;
    ...
    rv.x[1] = r * yterm;
    rv.x[2] = r * zterm;
    rv.v[0] = (vr * xterm) - (vu * (cos(lambda) * sin(u) + sin(lambda) * cos(u) * cos(i))) + (omegaE * rv.x[1]);
    rv.v[1] = (vr * yterm) - (vu * (sin(lambda) * sin(u) - cos(lambda) * cos(u) * cos(i))) - (omegaE * rv.x[0]);
...
inline void GLOCNavAlm::Corrected ::setp()
{
    p = a * (1.0 - epsilon * epsilon);
}

inline void GLOCNavAlm::Corrected ::setE(double L)
{
...
inline void GLOCNavAlm::Corrected ::setnu()
{
...
inline void GLOCNavAlm::Corrected ::setu()
{
    u = nu + omega;
}

inline void GLOCNavAlm::Corrected ::setr()
{
    r = p / (1.0 + (epsilon * cos(nu)));
}

inline void GLOCNavAlm::Corrected ::setvrvu()
{
