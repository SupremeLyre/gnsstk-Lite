...
Position lunarPosition(const CommonTime &t, double &AR)
{
    ...
    double lam =
        DEG_TO_RAD *
        (218.32 + 481267.883 * T + 6.29 * ::sin(DEG_TO_RAD * (134.9 + 477198.85 * T)) -
         1.27 * ::sin(DEG_TO_RAD * (259.2 - 413335.38 * T)) + 0.66 * ::sin(DEG_TO_RAD * (235.7 + 890534.23 * T)) +
         0.21 * ::sin(DEG_TO_RAD * (269.9 + 954397.70 * T)) - 0.19 * ::sin(DEG_TO_RAD * (357.5 + 35999.05 * T)) -
         0.11 * ::sin(DEG_TO_RAD * (259.2 + 966404.05 * T)));
    // ecliptic latitude
    double bet =
        DEG_TO_RAD *
        (5.13 * ::sin(DEG_TO_RAD * (93.3 + 483202.03 * T)) + 0.28 * ::sin(DEG_TO_RAD * (228.2 + 960400.87 * T)) -
         0.28 * ::sin(DEG_TO_RAD * (318.3 + 6003.18 * T)) - 0.17 * ::sin(DEG_TO_RAD * (217.6 - 407332.20 * T)));
    // horizontal parallax
    double par = DEG_TO_RAD * (0.9508 + 0.0518 * ::cos(DEG_TO_RAD * (134.9 + 477198.85 * T)) +
