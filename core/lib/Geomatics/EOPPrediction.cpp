...
int EOPPrediction::loadFile(const string &filename)
{
    ...
    if (!ok)
    {
        FileMissingException fme("EOPP File " + filename + " is corrupted or wrong format");
        GNSSTK_THROW(fme);
    }
    if (inpf.bad())
    {
...
int EOPPrediction::getSerialNumber(int imjd)
{
    ...
    if (w2 < 0)
    {
        GNSSTK_THROW(Exception("Invalid week in EOPP file: " + StringUtils::asString<short>(w2)));
    }
...
EarthOrientation EOPPrediction::computeEOP(double &mjd) const
{
    ...
    dt = t - ta;
    arg = TWO_PI * dt;
    eo.xp = A + B * dt + C1 * ::sin(arg / P1) + D1 * ::cos(arg / P1) + C2 * ::sin(arg / P2) + D2 * ::cos(arg / P2);
    eo.yp = E + F * dt + G1 * ::sin(arg / Q1) + H1 * ::cos(arg / Q1) + G2 * ::sin(arg / Q2) + H2 * ::cos(arg / Q2);

    dt = t - tb;
    arg = TWO_PI * dt;
    eo.UT1mUTC = I + J * dt + K1 * ::sin(arg / R1) + L1 * ::cos(arg / R1) + K2 * ::sin(arg / R2) +
                 L2 * ::cos(arg / R2) + K3 * ::sin(arg / R3) + L3 * ::cos(arg / R3) + K4 * ::sin(arg / R4) +
                 L4 * ::cos(arg / R4);
...
{
    os << fixed << setw(10) << setprecision(2) << eopp.ta << setw(10) << setprecision(6) << eopp.A << setw(10)
       << setprecision(6) << eopp.B << setw(10) << setprecision(6) << eopp.C1 << setw(10) << setprecision(6) << eopp.C2
       << setw(10) << setprecision(6) << eopp.D1 << setw(10) << setprecision(6) << eopp.D2 << setw(6) << setprecision(2)
       << eopp.P1 << "    " << endl;
    os << setw(6) << setprecision(2) << eopp.P2 << setw(10) << setprecision(6) << eopp.E << setw(10) << setprecision(6)
       << eopp.F << setw(10) << setprecision(6) << eopp.G1 << setw(10) << setprecision(6) << eopp.G2 << setw(10)
       << setprecision(6) << eopp.H1 << setw(10) << setprecision(6) << eopp.H2 << setw(6) << setprecision(2) << eopp.Q1
       << setw(6) << setprecision(2) << eopp.Q2 << "  " << endl;
    os << setw(10) << setprecision(2) << eopp.tb << setw(10) << setprecision(6) << eopp.I << setw(10) << setprecision(6)
       << eopp.J << setw(10) << setprecision(6) << eopp.K1 << setw(10) << setprecision(6) << eopp.K2 << setw(10)
       << setprecision(6) << eopp.K3 << setw(10) << setprecision(6) << eopp.K4 << "          " << endl;
    os << setw(10) << setprecision(6) << eopp.L1 << setw(10) << setprecision(6) << eopp.L2 << setw(10)
       << setprecision(6) << eopp.L3 << setw(10) << setprecision(6) << eopp.L4 << setw(9) << setprecision(4) << eopp.R1
       << setw(9) << setprecision(4) << eopp.R2 << setw(9) << setprecision(4) << eopp.R3 << setw(9) << setprecision(4)
       << eopp.R4 << "    " << endl;
    os << setw(4) << eopp.TAIUTC << setw(5) << eopp.SerialNo << setw(6) << int(eopp.tv + 0.5) << " " << eopp.Info
       << "                    "
       << "                    "
       << "      ";
    return os;
