...
/** @file EphTime.hpp
    gnsstk::EphTime - encapsulates date and time-of-day, but only in formats
    applicable to SolarSystemEphemeris, EarthOrientation and EOPStore, namely
    UTC, TT and TDB. Conversion to and from CommonTime should be automatic.*/
