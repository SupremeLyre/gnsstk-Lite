...
/// @file AtmLoadTides.cpp Classes to handle site displacement due to atmospheric loading.
...
Triple AtmLoadTides::computeDisplacement(string site, EphTime time, double UT1mUTC)
{
    try
    {
        ...
        {
            GNSSTK_THROW(Exception("Site not found in atmospheric loading store"));
        }
