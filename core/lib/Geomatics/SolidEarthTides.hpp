...
/** @file SolidEarthTides.hpp
    ...
    IERS pg 65 eq 17. The second equation referenced here is the permanent
    component. Class SolarSystem may be used to get Solar and Lunar ephemeris
    information, including position and mass ratios. */
