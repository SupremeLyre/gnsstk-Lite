  ...
  public:
    ...
    */
    ...
    /**
     ...
     store
    */
    bool getSatelliteAntenna(const char sys, const int n, std::string &name, AntexData &data,
    ...
    */
    Triple ComToPcVector(const char sys, const int n, const CommonTime &ct, const Triple &satVector,
                         bool inputPRN = true) const;
