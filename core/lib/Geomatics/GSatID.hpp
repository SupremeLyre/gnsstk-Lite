...
/// @file GSatID.hpp Define a satellite id class for geomatic lib, inheriting SatID.
  ...
  public:
    ...
    */
    ...
    std::string toString() const
    {
        ...
        oss << systemChar() << std::setw(2) << id << std::setfill(savechar);
        return oss.str();
    }
...
inline std::ostream &operator<<(std::ostream &s, const GSatID &sat)
{
    s << sat.toString();
    return s;
}
