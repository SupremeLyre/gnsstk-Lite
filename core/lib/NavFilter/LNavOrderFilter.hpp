 ...
 * set. */
struct LNavTimeSort : std::binary_function<LNavFilterData *, LNavFilterData *, bool>
{
...
bool LNavTimeSort ::operator()(const LNavFilterData *const &l, const LNavFilterData *const &r) const
{
