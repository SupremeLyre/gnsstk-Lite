...
struct LNavMsgSort : std::binary_function<LNavFilterData *, LNavFilterData *, bool>
{
...
bool LNavMsgSort ::operator()(const LNavFilterData *const &l, const LNavFilterData *const &r) const
{
