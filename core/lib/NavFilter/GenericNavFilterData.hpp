...
class GenericNavFilterData : public NavFilterKey
{
  public:
     ...
     */
    uint32_t getBitsSplit(unsigned firstBit1, unsigned numBits1, unsigned firstBit2, unsigned numBits2,
                          unsigned firstBit3 = 0, unsigned numBits3 = 0) const
    {
        uint32_t rv = ((getBits(firstBit1, numBits1) << numBits2) + (getBits(firstBit2, numBits2)));
