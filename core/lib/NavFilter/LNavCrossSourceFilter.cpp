...
namespace gnsstk
{
LNavCrossSourceFilter ::LNavCrossSourceFilter()
{
}
...
void LNavCrossSourceFilter ::finalize(NavMsgList &msgBitsOut)
{
    examineSubframes(msgBitsOut);
    groupedNav.clear();
    currentTime.reset();
...
void LNavCrossSourceFilter ::examineSubframes(NavMsgList &msgBitsOut)
{
