...
namespace gnsstk
{
LNavAlmValFilter ::LNavAlmValFilter()
{
}

void LNavAlmValFilter ::validate(NavMsgList &msgBitsIn, NavMsgList &msgBitsOut)
{
...
bool LNavAlmValFilter ::checkAlmValRange(LNavFilterData *fd)
{
    /// @todo implement this
    return true;
}
