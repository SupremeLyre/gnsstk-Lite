...
namespace gnsstk
{
CNavCrossSourceFilter ::CNavCrossSourceFilter() : minIdentical(2)
{
}

void CNavCrossSourceFilter ::validate(NavMsgList &msgBitsIn, NavMsgList &msgBitsOut)
{
...
void CNavCrossSourceFilter ::finalize(NavMsgList &msgBitsOut)
{
    examineMessages(msgBitsOut);
    groupedNav.clear();
    currentTime.reset();
...
void CNavCrossSourceFilter ::examineMessages(NavMsgList &msgBitsOut)
{
...
void CNavCrossSourceFilter::dump(std::ostream &s) const
{
    s << "#--------------------------------" << std::endl;
