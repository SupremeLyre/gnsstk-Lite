...
namespace gnsstk
{
LNavCookFilter ::LNavCookFilter()
{
}

void LNavCookFilter ::validate(NavMsgList &msgBitsIn, NavMsgList &msgBitsOut)
{
...
void LNavCookFilter ::cookSubframe(LNavFilterData *fd)
{
    unsigned word;
    ...
    {
        if (gnsstk::EngNav::getd30(fd->sf[word - 1]))
        {
