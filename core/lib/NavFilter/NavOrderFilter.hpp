 ...
 * set. */
struct NavTimeSort : std::binary_function<NavFilterKey *, NavFilterKey *, bool>
{
    inline bool operator()(const NavFilterKey *const &l, const NavFilterKey *const &r) const;
};
...
bool NavTimeSort ::operator()(const NavFilterKey *const &l, const NavFilterKey *const &r) const
{
