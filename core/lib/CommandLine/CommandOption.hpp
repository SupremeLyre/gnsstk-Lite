...
class CommandOption
{
  public:
     ...
     */
    CommandOption(const CommandOptionFlag of, const CommandOptionType ot, const char shOpt, const std::string &loOpt,
                  const std::string &desc, const bool req = false,
...
class RequiredOption : public CommandOption
{
  public:
    /// Constructor
    RequiredOption(const CommandOptionFlag of, const CommandOptionType ot, const char shOpt, const std::string &loOpt,
...
class CommandOptionWithArg : public CommandOption
{
  public:
    /// Constructor
    CommandOptionWithArg(const CommandOptionType ot, const char shOpt, const std::string &loOpt,
...
class CommandOptionWithAnyArg : public CommandOptionWithArg
{
  public:
    /// Constructor
    CommandOptionWithAnyArg(const char shOpt, const std::string &loOpt, const std::string &desc,
...
class CommandOptionWithStringArg : public CommandOptionWithArg
{
  public:
    /// Constructor
    CommandOptionWithStringArg(const char shOpt, const std::string &loOpt, const std::string &desc,
                               const bool required = false)
        : CommandOptionWithArg(stdType, shOpt, loOpt, desc, required)
    {
    }
...
class CommandOptionWithNumberArg : public CommandOptionWithArg
{
  public:
    /// Constructor
    CommandOptionWithNumberArg(const char shOpt, const std::string &loOpt, const std::string &desc,
                               const bool required = false)
        : CommandOptionWithArg(stdType, shOpt, loOpt, desc, required)
    {
    }
...
class CommandOptionWithDecimalArg : public CommandOptionWithArg
{
  public:
    /// Constructor
    CommandOptionWithDecimalArg(const char shOpt, const std::string &loOpt, const std::string &desc,
                                const bool required = false)
        : CommandOptionWithArg(stdType, shOpt, loOpt, desc, required)
    {
    }
...
class CommandOptionNOf : public CommandOption
{
  public:
     ...
     */
    CommandOptionNOf(const unsigned long num) : CommandOption(noArgument, metaType, 0, "", ""), N(num)
    {
        setMaxCount(num);
    }
...
class CommandOptionOneOf : public CommandOption
{
  public:
     ...
     * for this object to metaType.
     */
    CommandOptionOneOf() : CommandOption(noArgument, metaType, 0, "", "")
    {
    }
...
class CommandOptionMutex : public CommandOptionOneOf
{
  public:
     ...
     */
    CommandOptionMutex(const bool required = false) : doOneOfChecking(required)
    {
    }
...
class CommandOptionHelp : public CommandOption
{
  public:
     ...
     */
    CommandOptionHelp(const CommandOption::CommandOptionFlag of, const char shOpt, const std::string &loOpt,
                      const std::string &desc)
...
class CommandOptionHelpUsage : public CommandOptionHelp
{
  public:
     ...
     * @param[in] desc A string describing what this option does.
     */
    CommandOptionHelpUsage(const char shOpt = 'h', const std::string &loOpt = "help",
...
class CommandOptionHelpSimple : public CommandOptionHelp
{
  public:
     ...
     *   option is used.
     */
    CommandOptionHelpSimple(const char shOpt, const std::string &loOpt, const std::string &desc,
                            const std::string &help)
        : CommandOptionHelp(noArgument, shOpt, loOpt, desc), helpText(help)
    {
    }
