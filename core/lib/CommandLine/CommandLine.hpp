...
class CommandLine
{
  private:
    ...
    class Option
    {
      public:
        ...
        Option(void)
            : shortOpt(0), repeat(false), required(false), expand(true), toggle(false), type(typeUndefined),
              p_output(NULL), doc(true)
        {
        }

        Option(char s, std::string l, std::string a, std::string predes, std::string des, bool rep, bool req, typeOpt t,
               void *ptr, bool d)
        {
            shortOpt = s;
            longOpt = l;
  ...
  public:
    // -------------- member functions -------------------------------------
    // constructor
    CommandLine(void) : help(false), debug(-1), verbose(false), requireOneArg(true), syntaxPageBuilt(0)
    {
    }
    ...
    {
        if (has_arg)
            ignore_opts_with_arg.push_back(opt);
        else
            ignore_opts_without_arg.push_back(opt);
    }
    ...
    void Add(char s, std::string l, std::string a, bool rep, bool req, bool *ptr, std::string predes, std::string des,
             bool doc = true)
    {
    ...
    void Add(char s, std::string l, std::string a, bool rep, bool req, int *ptr, std::string predes, std::string des,
             bool doc = true)
    {
    ...
    void Add(char s, std::string l, std::string a, bool rep, bool req, std::vector<int> *ptr, std::string predes,
             std::string des, bool doc = true)
    {
    ...
    /// add a double option
    void Add(char s, std::string l, std::string a, bool rep, bool req, double *ptr, std::string predes, std::string des,
             bool doc = true)
    {
    ...
    /// add a string option
    void Add(char s, std::string l, std::string a, bool rep, bool req, std::string *ptr, std::string predes,
             std::string des, bool doc = true)
    {
    ...
    void Add(char s, std::string l, std::string a, bool rep, bool req, std::vector<std::string> *ptr,
             std::string predes, std::string des, bool doc = true)
    {
    ...
    void Add(char s, std::string l, std::string a, bool rep, bool req, gnsstk::RinexSatID *ptr, std::string predes,
             std::string des, bool doc = true)
    {
    ...
    void Add(char s, std::string l, std::string a, bool rep, bool req, std::vector<gnsstk::RinexSatID> *ptr,
             std::string predes, std::string des, bool doc = true)
    {
    ...
    void noExpansion(std::string l)
    {
        ...
        {
            if (options[i].longOpt == l && (options[i].type == typeVectorString || options[i].type == typeVectorSat ||
     ...
     * @throw Exception
     */
    int ProcessCommandLine(int argc, char **argv, std::string PrgmDesc, std::string &Usage, std::string &Errors,
