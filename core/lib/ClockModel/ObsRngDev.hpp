...
class ObsRngDev
{
  public:
     ...
     */
    ObsRngDev() noexcept : obstime(CommonTime::END_OF_TIME), wonky(0)
    {
    }
     ...
     */
    ObsRngDev(const double prange, const SatID &svid, const CommonTime &time, const Position &rxpos, NavLibrary &navLib,
              EllipsoidModel &em, bool svTime = false, NavSearchOrder order = NavSearchOrder::User,
     ...
     */
    ObsRngDev(const double prange, const SatID &svid, const CommonTime &time, const Position &rxpos, NavLibrary &navLib,
              EllipsoidModel &em, const IonoModelStore &ion, CarrierBand band, bool svTime = false,
              NavSearchOrder order = NavSearchOrder::User, SVHealth xmitHealth = SVHealth::Any,
     ...
     */
    ObsRngDev(const double prange, const SatID &svid, const CommonTime &time, const Position &rxpos, NavLibrary &navLib,
              EllipsoidModel &em, const TropModel &tm, bool svTime = false, NavSearchOrder order = NavSearchOrder::User,
              SVHealth xmitHealth = SVHealth::Any, NavValidityType valid = NavValidityType::ValidOnly);
     ...
     */
    ObsRngDev(const double prange, const SatID &svid, const CommonTime &time, const Position &rxpos, NavLibrary &navLib,
              EllipsoidModel &em, const TropModel &tm, const IonoModelStore &ion, CarrierBand band, bool svTime = false,
              NavSearchOrder order = NavSearchOrder::User, SVHealth xmitHealth = SVHealth::Any,
              NavValidityType valid = NavValidityType::ValidOnly);
     ...
     *   or invalid messages, or both.
     */
    ObsRngDev(const double prange1, const double prange2, const SatID &svid, const CommonTime &time,
              const Position &rxpos, NavLibrary &navLib, EllipsoidModel &em, bool svTime = false,
              double gamma = GAMMA_GPS, NavSearchOrder order = NavSearchOrder::User,
              SVHealth xmitHealth = SVHealth::Any, NavValidityType valid = NavValidityType::ValidOnly);
    ...
    ObsRngDev(const double prange1, const double prange2, const SatID &svid, const CommonTime &time,
              ...
              bool svTime = false, double gamma = GAMMA_GPS, NavSearchOrder order = NavSearchOrder::User,
              SVHealth xmitHealth = SVHealth::Any, NavValidityType valid = NavValidityType::ValidOnly);
  ...
  private:
    void computeOrd(double obs, const Position &rxpos, NavLibrary &navLib, const EllipsoidModel &em, bool svTime,
    ...
    void computeOrdTx(double obs, const Position &rxpos, NavLibrary &navLib, const EllipsoidModel &em,
                      NavSearchOrder order, SVHealth xmitHealth, NavValidityType valid);

    void computeOrdRx(double obs, const Position &rxpos, NavLibrary &navLib, const EllipsoidModel &em,
                      NavSearchOrder order, SVHealth xmitHealth, NavValidityType valid);
