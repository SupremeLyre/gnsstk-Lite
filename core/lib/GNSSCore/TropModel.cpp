...
double TropModel::correction(const Position &RX, const Position &SV, const CommonTime &tt)
{
    THROW_IF_INVALID();
...
void TropModel::setWeather(const double &T, const double &P, const double &H)
{
