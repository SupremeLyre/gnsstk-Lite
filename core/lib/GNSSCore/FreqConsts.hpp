 ...
 */
inline double getWavelength(SatelliteSystem sys, int rinexBandNum, int gloChan = 0) noexcept
{
    switch (sys)
    {
    case SatelliteSystem::GPS:
        ...
        {
        case 1:
            return WAVELENGTH_GPS_L1;
        case 2:
            return WAVELENGTH_GPS_L2;
        case 5:
            return WAVELENGTH_GPS_L5;
        }
        break;
    case SatelliteSystem::Glonass:
        ...
        case 4:
            return WAVELENGTH_GLONASS_G1a;
        case 6:
            return WAVELENGTH_GLONASS_G2a;
        case 2:
            return (C_MPS / (FREQ_GLONASS_G2 + gloChan * FREQ_STEP_GLONASS_G2));
        case 3:
            return WAVELENGTH_GLONASS_G3;
        }
        break;
    case SatelliteSystem::Galileo:
        ...
        {
        case 1:
            return WAVELENGTH_GALILEO_E1;
        case 7:
            return WAVELENGTH_GALILEO_E5b;
        case 8:
            return WAVELENGTH_GALILEO_E5;
        case 5:
            return WAVELENGTH_GALILEO_E5a;
        case 6:
            return WAVELENGTH_GALILEO_E6;
        }
        break;
    case SatelliteSystem::Geosync:
        ...
        {
        case 1:
            return WAVELENGTH_SBAS_L1;
        case 5:
            return WAVELENGTH_SBAS_L5;
        }
        break;
    case SatelliteSystem::QZSS:
        ...
        {
        case 1:
            return WAVELENGTH_QZSS_L1;
        case 2:
            return WAVELENGTH_QZSS_L2;
        case 5:
            return WAVELENGTH_QZSS_L5;
        case 6:
            return WAVELENGTH_QZSS_L6;
        }
        break;
    case SatelliteSystem::BeiDou:
        ...
        {
        case 1:
            return WAVELENGTH_BEIDOU_L1;
        case 2:
            return WAVELENGTH_BEIDOU_B1;
        case 7:
            return WAVELENGTH_BEIDOU_B2b;
        case 6:
            return WAVELENGTH_BEIDOU_B3;
        case 8:
            return WAVELENGTH_BEIDOU_B2;
        case 5:
            return WAVELENGTH_BEIDOU_B2a;
        }
        break;
    case SatelliteSystem::IRNSS:
        ...
        {
        case 9:
            return WAVELENGTH_NAVIC_S;
        case 5:
            return WAVELENGTH_NAVIC_L5;
        }
        break;
    default:
        break;
 ...
 *   for the system. */
inline double getBeta(SatelliteSystem sys, int na, int nb) noexcept
{
...
inline double getAlpha(SatelliteSystem sys, int na, int nb) noexcept
{
