...
RinexSatID ::RinexSatID(int p, SatelliteSystem s) noexcept : SatID(p, s)
{
    validate();
}

char RinexSatID ::systemChar() const noexcept
{
    switch (system)
    {
...
std::string RinexSatID ::systemString() const noexcept
{
    switch (system)
    {
    case SatelliteSystem::GPS:
...
std::string RinexSatID ::systemString3() const noexcept
{
    switch (system)
    {
    case SatelliteSystem::GPS:
    ...
    case SatelliteSystem::Geosync:
        return "GEO";
    case SatelliteSystem::Transit:
        return "TRN"; // RINEX ver 2
    case SatelliteSystem::QZSS:
        return "QZS";
    case SatelliteSystem::BeiDou:
        return "BDS";
    case SatelliteSystem::IRNSS:
        return "IRN"; // RINEX ver 3.03
    case SatelliteSystem::Mixed:
        return "Mix";
    default:
        return "Unk";
...
void RinexSatID ::fromString(const std::string &s)
{
    char c;
    ...
    default: // non-RINEX system character
        Exception e(std::string("Invalid system character \"") + c + std::string("\""));
        GNSSTK_THROW(e);
    }
    iss >> id;
    if (id <= 0)
...
std::string RinexSatID ::toString() const noexcept
{
