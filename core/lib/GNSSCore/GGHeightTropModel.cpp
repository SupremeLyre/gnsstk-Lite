...
#define THROW_IF_INVALID_DETAILED()                                                                                    \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            if (!validHeights)                                                                                         \
                e.addText("Invalid trop model: validHeights");                                                         \
            if (!validRxHeight)                                                                                        \
...
GGHeightTropModel::GGHeightTropModel(const double &T, const double &P, const double &H)
{
    validRxHeight = validHeights = false;
    setWeather(T, P, H);
}

GGHeightTropModel::GGHeightTropModel(const double &T, const double &P, const double &H, const double hT,
                                     const double hP, const double hH)
{
    validRxHeight = false;
    setWeather(T, P, H);
    setHeights(hT, hP, hH);
...
double GGHeightTropModel::correction(const Position &RX, const Position &SV, const CommonTime &tt)
{
    THROW_IF_INVALID_DETAILED();
...
double GGHeightTropModel::correction(const Xvt &RX, const Xvt &SV, const CommonTime &tt)
{
    Position R(RX), S(SV);
...
void GGHeightTropModel::setWeather(const double &T, const double &P, const double &H)
{
    try
    {
...
void GGHeightTropModel::setHeights(const double &hT, const double &hP, const double &hH)
{
