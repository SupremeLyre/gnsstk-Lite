...
std::map<char, ObservationType> RinexObsID::char2ot{
    {' ', ObservationType::Unknown}, {'*', ObservationType::Any},     {'C', ObservationType::Range},
    {'L', ObservationType::Phase},   {'D', ObservationType::Doppler}, {'S', ObservationType::SNR},
    {'X', ObservationType::Channel}, {'I', ObservationType::Iono},    {'-', ObservationType::Undefined},
}; // std::map<char, ObservationType> RinexObsID::char2ot

std::map<char, CarrierBand> RinexObsID::char2cb{
    {' ', CarrierBand::Unknown}, {'*', CarrierBand::Any},  {'1', CarrierBand::L1},  {'2', CarrierBand::L2},
    {'5', CarrierBand::L5},      {'4', CarrierBand::G1a},  {'6', CarrierBand::G2a}, {'3', CarrierBand::G3},
    {'7', CarrierBand::E5b},     {'8', CarrierBand::E5ab}, {'9', CarrierBand::I9},  {'-', CarrierBand::Undefined},
}; // std::map<char, CarrierBand> RinexObsID::char2cb

std::map<char, TrackingCode> RinexObsID::char2tc{
    {' ', TrackingCode::Unknown},   {'*', TrackingCode::Any},
    {'C', TrackingCode::CA},        {'P', TrackingCode::P},
    {'Y', TrackingCode::Y},         {'W', TrackingCode::Ztracking},
    {'N', TrackingCode::YCodeless}, {'D', TrackingCode::Semicodeless},
    {'M', TrackingCode::MDP},       {'S', TrackingCode::L2CM},
    {'L', TrackingCode::L2CL},      {'X', TrackingCode::L2CML},
    {'I', TrackingCode::L5I},       {'Q', TrackingCode::L5Q},
    {'A', TrackingCode::L1OCD},     {'B', TrackingCode::L1OCP},
    {'Z', TrackingCode::E1ABC},     {'E', TrackingCode::L6E},
    {'-', TrackingCode::Undefined},
}; // std::map<char, TrackingCode> RinexObsID::char2tc

std::map<ObservationType, char> RinexObsID::ot2char{
    {ObservationType::Unknown, ' '}, {ObservationType::Any, '*'},     {ObservationType::Range, 'C'},
    {ObservationType::Phase, 'L'},   {ObservationType::Doppler, 'D'}, {ObservationType::SNR, 'S'},
    {ObservationType::Channel, 'X'}, {ObservationType::Iono, 'I'},    {ObservationType::Undefined, '-'},
}; // std::map<ObservationType, char> RinexObsID::ot2char

std::map<CarrierBand, char> RinexObsID::cb2char{
    {CarrierBand::Unknown, ' '}, {CarrierBand::Any, '*'},       {CarrierBand::L1, '1'},  {CarrierBand::L2, '2'},
    {CarrierBand::L5, '5'},      {CarrierBand::G1, '1'},        {CarrierBand::G1a, '4'}, {CarrierBand::G2a, '6'},
    {CarrierBand::G2, '2'},      {CarrierBand::G3, '3'},        {CarrierBand::E5b, '7'}, {CarrierBand::E5ab, '8'},
    {CarrierBand::E6, '6'},      {CarrierBand::B1, '2'},        {CarrierBand::B2, '7'},  {CarrierBand::B3, '6'},
    {CarrierBand::I9, '9'},      {CarrierBand::Undefined, '-'},
}; // std::map<CarrierBand, char> RinexObsID::cb2char

std::map<TrackingCode, char> RinexObsID::tc2char{
    {TrackingCode::Unknown, ' '},    {TrackingCode::Any, '*'},
    {TrackingCode::CA, 'C'},         {TrackingCode::P, 'P'},
    {TrackingCode::Y, 'Y'},          {TrackingCode::Ztracking, 'W'},
    {TrackingCode::YCodeless, 'N'},  {TrackingCode::Semicodeless, 'D'},
    {TrackingCode::MDP, 'M'},        {TrackingCode::L2CM, 'S'},
    {TrackingCode::L2CL, 'L'},       {TrackingCode::L2CML, 'X'},
    {TrackingCode::L5I, 'I'},        {TrackingCode::L5Q, 'Q'},
    {TrackingCode::L5IQ, 'X'},       {TrackingCode::L1CP, 'L'},
    {TrackingCode::L1CD, 'S'},       {TrackingCode::L1CDP, 'X'},
    {TrackingCode::Standard, 'C'},   {TrackingCode::Precise, 'P'},
    {TrackingCode::L3OCD, 'I'},      {TrackingCode::L3OCP, 'Q'},
    {TrackingCode::L3OCDP, 'X'},     {TrackingCode::L1OCD, 'A'},
    {TrackingCode::L1OCP, 'B'},      {TrackingCode::L1OCDP, 'X'},
    {TrackingCode::L2CSIL2OCp, 'X'}, {TrackingCode::L2CSI, 'A'},
    {TrackingCode::L2OCP, 'B'},      {TrackingCode::E1A, 'A'},
    {TrackingCode::E1B, 'B'},        {TrackingCode::E1C, 'C'},
    {TrackingCode::E1BC, 'X'},       {TrackingCode::E1ABC, 'Z'},
    {TrackingCode::E5abI, 'I'},      {TrackingCode::E5abQ, 'Q'},
    {TrackingCode::E5abIQ, 'X'},     {TrackingCode::E5aI, 'I'},
    {TrackingCode::E5aQ, 'Q'},       {TrackingCode::E5aIQ, 'X'},
    {TrackingCode::E5bI, 'I'},       {TrackingCode::E5bQ, 'Q'},
    {TrackingCode::E5bIQ, 'X'},      {TrackingCode::E6A, 'A'},
    {TrackingCode::E6B, 'B'},        {TrackingCode::E6C, 'C'},
    {TrackingCode::E6BC, 'X'},       {TrackingCode::E6ABC, 'Z'},
    {TrackingCode::L1S, 'Z'},        {TrackingCode::L5SI, 'D'},
    {TrackingCode::L5SQ, 'P'},       {TrackingCode::L5SIQ, 'Z'},
    {TrackingCode::LEXS, 'S'},       {TrackingCode::LEXL, 'L'},
    {TrackingCode::LEXSL, 'X'},      {TrackingCode::L6D, 'S'},
    {TrackingCode::L6E, 'E'},        {TrackingCode::L6DE, 'Z'},
    {TrackingCode::B1I, 'I'},        {TrackingCode::B1Q, 'Q'},
    {TrackingCode::B1IQ, 'X'},       {TrackingCode::B2I, 'I'},
    {TrackingCode::B2Q, 'Q'},        {TrackingCode::B2IQ, 'X'},
    {TrackingCode::B3I, 'I'},        {TrackingCode::B3Q, 'Q'},
    {TrackingCode::B3IQ, 'X'},       {TrackingCode::B1A, 'A'},
    {TrackingCode::B1CD, 'D'},       {TrackingCode::B1CDP, 'X'},
    {TrackingCode::B1CP, 'P'},       {TrackingCode::B2abI, 'D'},
    {TrackingCode::B2abIQ, 'X'},     {TrackingCode::B2abQ, 'P'},
    {TrackingCode::B2aI, 'D'},       {TrackingCode::B2aIQ, 'X'},
    {TrackingCode::B2aQ, 'P'},       {TrackingCode::B2bI, 'D'},
    {TrackingCode::B2bIQ, 'Z'},      {TrackingCode::B2bQ, 'P'},
    {TrackingCode::BCodeless, 'N'},  {TrackingCode::B3AIQ, 'A'},
    {TrackingCode::SPSL5, 'A'},      {TrackingCode::RSL5D, 'B'},
    {TrackingCode::RSL5P, 'C'},      {TrackingCode::RSL5DP, 'X'},
    {TrackingCode::SPSS, 'A'},       {TrackingCode::RSSD, 'B'},
    {TrackingCode::RSSP, 'C'},       {TrackingCode::RSSDP, 'X'},
    {TrackingCode::Undefined, '-'},
}; // std::map<TrackingCode, char> RinexObsID::tc2char

// map of valid RINEX tracking codes, systems and frequency
std::map<char, std::map<char, std::string>> RinexObsID::validRinexTrackingCodes{
    {'G',
    ...
    {'R', {{'1', "PC* "}, {'2', "PC* "}, {'3', "IQX* "}, {'4', "ABX* "}, {'6', "ABX* "}}},

    {'E', {{'1', "ABCXZ* "}, {'5', "IQX* "}, {'6', "ABCXZ* "}, {'7', "IQX* "}, {'8', "IQX* "}}},

    {'S', {{'1', "C* "}, {'5', "IQX* "}}},

    {'J', {{'1', "CSLXZ* "}, {'2', "SLX* "}, {'5', "IQDPXZ* "}, {'6', "ESLXZ* "}}},
    ...
    {'I',
     {{'1', "* "}, // I1 is *only* for channel number
      {'5', "ABCX* "},
      {'9', "ABCX* "}}}}; // RinexObsID::validRinexTrackingCodes

RinexObsID::RinexObsID(const std::string &strID, double version) : rinexVersion(version)
{
