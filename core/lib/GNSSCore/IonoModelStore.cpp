 ...
 */
double IonoModelStore::getCorrection(const CommonTime &time, const Position &rxgeo, double svel, double svaz,
 ...
 */
bool IonoModelStore::addIonoModel(const CommonTime &mt, const IonoModel &im) noexcept
{
    if (!im.isValid())
        return false;
 ...
 */
void IonoModelStore::edit(const CommonTime &tmin, const CommonTime &tmax)
{
