...
GGTropModel::GGTropModel(const double &T, const double &P, const double &H)
{
    setWeather(T, P, H);
    valid = true;
}
...
double GGTropModel::dry_mapping_function(double elevation) const
{
    ...
    double Rd = SQRT((ell.a() + Cdrymap) * (ell.a() + Cdrymap) - ell.a() * ell.a() * ce * ce) - ell.a() * se;
...
double GGTropModel::wet_mapping_function(double elevation) const
{
    ...
    double Rw = SQRT((ell.a() + Cwetmap) * (ell.a() + Cwetmap) - ell.a() * ell.a() * ce * ce) - ell.a() * se;
...
void GGTropModel::setWeather(const double &T, const double &P, const double &H)
{
