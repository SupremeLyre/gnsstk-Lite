...
std::string asString(ObservationType e) noexcept
{
    ...
    case ObservationType::SNR:
        return "SNR";
    case ObservationType::Channel:
        return "Channel";
    case ObservationType::DemodStat:
        return "DemodStat";
    case ObservationType::Iono:
        return "Iono";
    ...
    case ObservationType::TrackLen:
        return "TrackLen";
    case ObservationType::NavMsg:
        return "NavMsg";
    case ObservationType::RngStdDev:
        return "RngStdDev";
    case ObservationType::PhsStdDev:
        return "PhsStdDev";
    case ObservationType::FreqIndx:
        return "FreqIndx";
