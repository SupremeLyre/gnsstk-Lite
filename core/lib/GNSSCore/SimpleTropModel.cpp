...
SimpleTropModel::SimpleTropModel(const double &T, const double &P, const double &H)
{
    setWeather(T, P, H);
    valid = true;
}

void SimpleTropModel::setWeather(const double &T, const double &P, const double &H)
{
