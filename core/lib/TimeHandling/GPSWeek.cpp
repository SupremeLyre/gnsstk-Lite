...
std::string GPSWeek::printf(const std::string &fmt) const
{
    try
    {
        ...
        rv = formattedPrint(rv, getFormatPrefixInt() + "G", "Gu", getWeek10());
...
std::string GPSWeek::printError(const std::string &fmt) const
{
    try
    {
        ...
        rv = formattedPrint(rv, getFormatPrefixInt() + "E", "Es", getError().c_str());
        rv = formattedPrint(rv, getFormatPrefixInt() + "F", "Fs", getError().c_str());
        rv = formattedPrint(rv, getFormatPrefixInt() + "G", "Gs", getError().c_str());
