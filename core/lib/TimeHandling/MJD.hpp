...
#ifndef GNSSTK_MJD_HPP
#define GNSSTK_MJD_HPP
...
class MJD : public TimeTag
{
  public:
    ...
    MJD(long double m = 0., TimeSystem ts = TimeSystem::Unknown) : mjd(m)
    {
        timeSystem = ts;
    }
     ...
     */
    MJD(const MJD &right) : mjd(right.mjd)
    {
