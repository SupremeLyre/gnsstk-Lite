...
#ifndef GNSSTK_ANSITIME_HPP
#define GNSSTK_ANSITIME_HPP
...
class ANSITime : public TimeTag
{
  public:
     ...
     */
    ANSITime(time_t t = 0, const TimeSystem &ts = TimeSystem::Unknown) : time(t)
    {
        timeSystem = ts;
    }
     ...
     */
    ANSITime(const ANSITime &right) : time(right.time)
    {
