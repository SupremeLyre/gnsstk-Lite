...
#ifndef GNSSTK_WEEKSECOND_HPP
#define GNSSTK_WEEKSECOND_HPP
...
class WeekSecond : public Week
{
  public:
     ...
     */
    WeekSecond(unsigned int w = 0, double s = 0., TimeSystem ts = TimeSystem::Unknown) : Week(w), sow(s)
    {
        timeSystem = ts;
    }
     ...
     */
    WeekSecond(const WeekSecond &right) : Week(right), sow(right.sow)
    {
