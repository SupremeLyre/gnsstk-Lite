...
#ifndef GNSSTK_SYSTEMTIME_HPP
#define GNSSTK_SYSTEMTIME_HPP
 ...
 * a UnixTime.
 */
class SystemTime : public UnixTime
{
  public:
    /**
     ...
     */
    SystemTime(const SystemTime &right) : UnixTime(right)
    {
    }
