...
#ifndef GNSSTK_BLQDATAREADER_HPP
#define GNSSTK_BLQDATAREADER_HPP
...
class BLQDataReader : public FFTextStream
{
  public:
     ...
     *
     */
    BLQDataReader(const std::string &fn) : FFTextStream(fn.c_str(), std::ios::in)
    {
        loadData();
    };
...
#endif // GNSSTK_BLQDATAREADER_HPP
