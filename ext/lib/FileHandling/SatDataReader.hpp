...
#ifndef GNSSTK_SATDATAREADER_HPP
#define GNSSTK_SATDATAREADER_HPP
...
#pragma clang diagnostic pop
  ...
  private:
    ...
    struct svData
    {
        ...
        svData()
            : launchDate(CommonTime::BEGINNING_OF_TIME), deactivationDate(CommonTime::END_OF_TIME), gpsNumber(0),
              block("")
        {
        }
...
#endif // GNSSTK_SATDATAREADER_HPP
