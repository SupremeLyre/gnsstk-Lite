...
void ConfDataReader::loadData(void)
{
    ...
    while (1)
    {
        try
        {
            ...
            if ((StringUtils::firstWord(line)[0] == '#') || (StringUtils::firstWord(line)[0] == ';'))
            {
                formattedGetLine(line, true);
            }
            ...
            if (!(idx == std::string::npos))
            {
                ...
                if (!(idx2 == std::string::npos))
                {
                    ...
                    else
                    {
                        ...
                        ConfigurationException e("Section name '" + line + "' in configuration file '" + filename +
                ...
                else
                {
                    ...
                    ConfigurationException e("Section line '" + line + "' in configuration file '" + filename +
            ...
            if (!(idx == std::string::npos))
            {
                ...
                else
                {
                    ...
                    ConfigurationException e("Variable name '" + variable + "' in configuration file '" + filename +
                                             "' does not comply with rules.");
 ...
 * 'variableList'.
 */
bool ConfDataReader::fetchListValueAsBoolean(string variableList, string section, bool defaultVal)
{
    ...
    try
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // Throw an exception if value is neither TRUE nor FALSE
                ConfigurationException e("Variable list '" + variableList + "' in configuration file '" + filename +
        ...
        else
        {
            ...
            if (issueException)
            {
                ...
                ConfigurationException e("Variable '" + variable + "' in section '" + section +
                                         "' of configuration file '" + filename + "' does not exist.");
        ...
        if (issueException)
        {
            ...
            if (section == "DEFAULT")
            {
                ...
                ConfigurationException e("Section 'DEFAULT' in configuration file '" + filename +
                                         "' does not exist. Does file '" + filename + "' exist?. Do you have " +
            ...
            else
            {
                ...
                // Throw an exception if section name doesn't exist
                ConfigurationException e("Section '" + section + "' in configuration file '" + filename +
                                         "' does not exist.");
