 ...
 */
string SatDataReader::getBlock(const SatID &sat, const CommonTime &epoch) const
{
 ...
 */
int SatDataReader::getGPSNumber(const SatID &sat, const CommonTime &epoch) const
{
 ...
 */
CommonTime SatDataReader::getLaunchDate(const SatID &sat, const CommonTime &epoch) const
{
 ...
 */
CommonTime SatDataReader::getDeactivationDate(const SatID &sat, const CommonTime &epoch) const
{
