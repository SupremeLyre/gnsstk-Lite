...
class ConfDataReader : public FFTextStream
{
  public:
    /// Default constructor
    ConfDataReader() : issueException(true), fallback2Default(false) {};
     ...
     *
     */
    ConfDataReader(const char *file) : FFTextStream(file, std::ios::in), issueException(true), fallback2Default(false)
    {
        loadData();
    };
    ...
    ConfDataReader(const std::string &file)
        : FFTextStream(file.c_str(), std::ios::in), issueException(true), fallback2Default(false)
    {
        loadData();
    };
...
#pragma clang diagnostic pop
    ...
    {
        return StringUtils::asDouble(getValue(variable, section, StringUtils::asString(defaultVal)));
    };
    ...
    {
        return StringUtils::asInt(getValue(variable, section, StringUtils::asString(defaultVal)));
    };
     ...
     * 'variableList'.
     */
    virtual std::string fetchListValue(std::string variableList, std::string section = "DEFAULT",
     ...
     * 'variableList'.
     */
    virtual double fetchListValueAsDouble(std::string variableList, std::string section = "DEFAULT",
                                          double defaultVal = 0.0)
    {
        return StringUtils::asDouble(fetchListValue(variableList, section, StringUtils::asString(defaultVal)));
    };
    ...
    {
        return StringUtils::asInt(fetchListValue(variableList, section, StringUtils::asString(defaultVal)));
    };
     ...
     */
    virtual bool fetchListValueAsBoolean(std::string variableList, std::string section = "DEFAULT",
