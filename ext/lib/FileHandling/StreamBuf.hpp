...
#ifndef GNSSTK_STREAMBUF_HPP
#define GNSSTK_STREAMBUF_HPP
...
template <typename ch, typename tr> class BasicStreamBuf : public std::basic_streambuf<ch, tr>
{
  protected:
...
#endif // GNSSTK_BASICSTREAMBUF_HPP
