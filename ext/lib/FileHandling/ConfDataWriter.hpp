...
#ifndef GNSSTK_CONFDATA_WRITER_HPP
#define GNSSTK_CONFDATA_WRITER_HPP
...
class ConfDataWriter : public FFTextStream
{
  public:
     ...
     *
     */
    ConfDataWriter(const char *file) : FFTextStream(file, std::ios::out)
    {
        writeHeader();
    };
     ...
     *
     */
    ConfDataWriter(const std::string &file) : FFTextStream(file.c_str(), std::ios::out)
    {
        writeHeader();
    };
...
#pragma clang diagnostic pop
     ...
     */
    void writeVariable(const std::string &var, const std::string &val, const std::string &varComment = "",
     ...
     * @param valComment   value comment
     */
    void writeVariable(const std::string &var, const int &val, const std::string &varComment = "",
                       const std::string &valComment = "")
    {
     ...
     * @param valComment   value comment
     */
    void writeVariable(const std::string &var, const double &val, const std::string &varComment = "",
                       const std::string &valComment = "");
     ...
     * @param valComment   value comment
     */
    void writeVariableList(const std::string &var, const std::string valList[], const int &n,
     ...
     * @param valComment   value comment
     */
    void writeVariableList(const std::string &var, std::vector<std::string> valList, const std::string &varComment = "",
                           const std::string &valComment = "");
     ...
     * @param valComment   value comment
     */
    void writeVariableList(const std::string &var, const int valList[], const int &n,
                           const std::string &varComment = "", const std::string &valComment = "");
     ...
     * @param valComment   value comment
     */
    void writeVariableList(const std::string &var, const double valList[], const int &n,
                           const std::string &varComment = "", const std::string &valComment = "");
...
#endif //  GNSSTK_CONFDATA_WRITER_HPP
